...
common_keys: list ["ip", "ipv6", "device_model", "os_name", "os_ver", "mac_addr", "udid", "unisdk_deviceid", "app_channel", "app_ver", "network", "imei", "device_height", "device_width", "isp", "nation", "engine_ver", "patch_ver", "account_id", "server", ... +20 more]
...
operationKeys: table {
  ...
  ItemRec: <table>
  Load: list ["reach_game_time", "load_time_long", "default_level", "setting_level"]
  LoadFinish: list ["default_level", "setting_level"]
  LoginUI: list ["reach_login_time", "is_grey", "API", "default_level", "setting_level", "total_mem"]
  ...
  friend_rec: <table>
  guise_apply: <table>
  inspection_check_global_speed: <table>
  inspection_check_invincible: <table>
  ...
  navigation_bar_post: <table>
  pharos_login: list ["udid"]
  pharos_logins: <table>
