...
DIFF_SIZE_LOW_TO_LOW_LOW: 6442450944
...
FENBAO_BAICAOYE: "baicaoye"

FENBAO_BUILDING: "building"

FENBAO_CUTSCENE: "cutscene"

FENBAO_HEXI: "hexi"

FENBAO_KAIFENG: "kaifeng"
...
LITE_PAK_CACHE_FOLDER: "tr_pak"

LITE_STATE_L2N_CANCEL: 13

LITE_STATE_L2N_DOWNLOADING: 11

LITE_STATE_L2N_FINISH: 12

LITE_STATE_L2N_FORCE_SWITCH: 14

LITE_STATE_L2N_NO_SPACE: 15

LITE_STATE_L2N_WRITING: 16

LITE_STATE_L2N_WRITING_NO_SPACE: 17

LITE_STATE_N2L_CANCEL: 3

LITE_STATE_N2L_DOWNLOADING: 1

LITE_STATE_N2L_FINISH: 2

LITE_STATE_N2L_FORCE_SWITCH: 4

LITE_STATE_N2L_NO_SPACE: 5

LITE_STATE_N2L_WRITING: 6

LITE_STATE_N2L_WRITING_NO_SPACE: 7

LITE_STATE_NONE: 0

LOAD_MPK_FAIL: "load_mpk_fail"

LOW_LOW_PACKAGE_SIZE: 20401094656

LOW_PACKAGE_SIZE: 26843545600

LS_CHECK_FILE_BATCH_SIZE: 3000

LS_DOWNLOAD_STAGE_ID: 4

LS_DOWNLOAD_TASK_SUBMIT_BATCH_SIZE: 3000

LS_LOAD_LOCAL_PAK_BATCH_SIZE: 500

LS_OPTIMIZE_RATE: 0.5

LS_PATCHLIST_DICT_STAGE_ID: 2

LS_PATCHLIST_STAGE_ID: 3

LS_PATCHMD5_STAGE_ID: 1
...
ORBIT_DOWNLOAD_FAIL_TAG: "OrbitDownloadFail.tag"
...
SOUND_CHINESE: "Chinese"

SOUND_ENGLISH: "English"
...
SOUND_PATH_ROOT: "Sounds/"

SOUND_SETTINGS: instance {
  -- Metatable:
  --   __index: table
  --   __tostring: yes
  1: "rtpc_master_volume"
  2: "rtpc_music_volume"
}

SOUND_SETTINGS_FILE: "patch_sound_setting.json"
