...
SimplePatchMpk: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "patch/simple_patchmpk.lua"
  ...
  get_file_info: function(arg1, arg2)  -- @patch/simple_patchmpk.lua:204-206
  ...
  transform_string: function(arg1, arg2)  -- @patch/simple_patchmpk.lua:208-214
  update_batch_info: function(arg1, arg2)  -- @patch/simple_patchmpk.lua:156-175
  update_engine_mpk_info: function(arg1, arg2)  -- @patch/simple_patchmpk.lua:177-202
}
