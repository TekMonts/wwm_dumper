...
PlayerBase: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/common/property_define/avatar/player_base.lua"
  __property_all__: instance {
    ...
    oversea_tag_imm: 0
    oversea_task_fetch_progress: <circular>
    oversea_task_finish_progress: <circular>
    ps_session: ""
    ps_social_flag: false
    psn_user_name: ""
    raw_create_time: 0.0
    recent_online_day_time: <circular>
    rename_time: 0
    role_type: 2
    server_version: 0
    social_mode: 0
    ...
    trophy_done: class {
      ...
      __module__: "hexm/common/property_define/avatar/player_base.lua"
      get_trophy_item: function(arg1, arg2)  -- @hexm/common/property_define/avatar/player_base.lua:117-122
    }
  }
