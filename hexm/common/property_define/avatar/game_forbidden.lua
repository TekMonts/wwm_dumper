-- ======================================================================
-- Module: hexm.common.property_define.avatar.game_forbidden
...
GameForbiddenFlags: <class>

GameForbiddenProp: class {
  -- Metatable:
  --   __tostring: yes
...
-- End of hexm.common.property_define.avatar.game_forbidden