...
Listener: class {
  ...
  --   __tostring: yes
  __tostring: nil
  _handle_dispatch_failed_: function(arg1)  -- @hexm/common/dispatcher.lua:598-600
  cancel: function(...)  -- =[C]
  ctor: function(...)  -- =[C]
  new: function(...)  -- =[C]
}
...
concat_event: function(arg1)  -- @hexm/common/dispatcher.lua:753-755

test: function()  -- @hexm/common/dispatcher.lua:759-826

test_scope: function()  -- @hexm/common/dispatcher.lua:828-889
