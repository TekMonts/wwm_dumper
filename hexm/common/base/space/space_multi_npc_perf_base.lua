-- ======================================================================
-- Module: hexm.common.base.space.space_multi_npc_perf_base
...
SpaceMultiNpcPerfBase: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/common/base/space/space_multi_npc_perf_base.lua:13-15
  __module__: "hexm/common/base/space/space_multi_npc_perf_base.lua"
...
-- End of hexm.common.base.space.space_multi_npc_perf_base