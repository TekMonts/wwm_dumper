-- ======================================================================
-- Module: hexm.common.base.swim_base
...
SwimBase: class {
  ...
  --   __tostring: yes
  __across_scene: true
  __init_component__: function(arg1)  -- @hexm/common/base/swim_base.lua:23-37
  __module__: "hexm/common/base/swim_base.lua"
...
-- End of hexm.common.base.swim_base