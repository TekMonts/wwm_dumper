-- ======================================================================
-- Module: hexm.common.base.target_filter_base
...
TargetFilterBase: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/common/base/target_filter_base.lua:15-20
  __module__: "hexm/common/base/target_filter_base.lua"
...
-- End of hexm.common.base.target_filter_base