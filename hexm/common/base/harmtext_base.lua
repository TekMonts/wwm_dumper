-- ======================================================================
-- Module: hexm.common.base.harmtext_base
...
HarmtextBase: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/common/base/harmtext_base.lua:30-33
  __module__: "hexm/common/base/harmtext_base.lua"
...
-- End of hexm.common.base.harmtext_base