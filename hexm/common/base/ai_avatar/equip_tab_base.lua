-- ======================================================================
-- Module: hexm.common.base.ai_avatar.equip_tab_base
...
EquipTabBase: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1)  -- @hexm/common/base/ai_avatar/equip_tab_base.lua:13-15
  __module__: "hexm/common/base/ai_avatar/equip_tab_base.lua"
...
-- End of hexm.common.base.ai_avatar.equip_tab_base