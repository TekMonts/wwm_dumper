-- ======================================================================
-- Module: hexm.common.base.ai_avatar.bow_weapon
...
BowWeapon: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1)  -- @hexm/common/base/ai_avatar/bow_weapon.lua:10-15
  __module__: "hexm/common/base/ai_avatar/bow_weapon.lua"
...
-- End of hexm.common.base.ai_avatar.bow_weapon