...
default_state: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/common/base/ai_avatar/states/state_default.lua"
...
state_configs: instance {
  ...
  action_group: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/base/ai_avatar/states/state_action_group.lua"
  ...
  behit: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/base/ai_avatar/states/state_behit.lua"
  ...
  control: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/base/ai_avatar/states/state_control.lua"
  ...
  dead: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/base/ai_avatar/states/state_dead.lua"
    enter: function(arg1, arg2)  -- @hexm/common/base/ai_avatar/states/state_dead.lua:12-21
  }
  defence: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/base/ai_avatar/states/state_defence.lua"
  ...
  idle: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/base/ai_avatar/states/state_idle.lua"
  ...
  revive: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/base/ai_avatar/states/state_revive.lua"
    enter: function(arg1, ...)  -- @hexm/common/base/ai_avatar/states/state_revive.lua:12-22
    leave: function(arg1, ...)  -- @hexm/common/base/ai_avatar/states/state_revive.lua:24-32
  }
  run: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/base/ai_avatar/states/state_run.lua"
  ...
  skill: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/base/ai_avatar/states/state_skill.lua"
