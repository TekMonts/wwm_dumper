-- ======================================================================
-- Module: hexm.common.base.ai_avatar.combat_player_static
...
CombatPlayerStatic: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1)  -- @hexm/common/base/ai_avatar/combat_player_static.lua:14-17
  __module__: "hexm/common/base/ai_avatar/combat_player_static.lua"
...
-- End of hexm.common.base.ai_avatar.combat_player_static