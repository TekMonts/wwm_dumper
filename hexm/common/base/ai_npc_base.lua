...
AINpcBase: class {
  ...
  BFSM_STATE_CONFIG_TRANSITIONS: instance {
    ...
    server/AI/npc_state/auto_chess_btree_client.se: instance {
      -- Metatable:
      --   __index: table
      --   __tostring: yes
      bayonet: <dict>
    ...
    server/AI/npc_state/jinou_btree.se: instance {
      -- Metatable:
      --   __index: table
      --   __tostring: yes
      alert: instance {
    ...
    server/AI/npc_state/monster_btree_qiongqi.se: instance {
      -- Metatable:
      --   __index: table
      --   __tostring: yes
      alert: instance {
      ...
      die: instance {
        ...
        13: instance {
          ...
          1: instance {
            ...
            --   __index: table
            --   __tostring: yes
            1: "server/AI/state_check/2_npc/qiongqi_dead_to_fight.ets"
            2: "fight"
          }
        }
      }
    ...
    server/AI/npc_state/niaoren_yuancheng_btree.se: instance {
      -- Metatable:
      --   __index: table
      --   __tostring: yes
      alert: instance {
    ...
    server/AI/npc_state/shulaibao_btree.se: instance {
      -- Metatable:
      --   __index: table
      --   __tostring: yes
      alert: instance {
  ...
  __module__: "hexm/common/base/ai_npc_base.lua"
