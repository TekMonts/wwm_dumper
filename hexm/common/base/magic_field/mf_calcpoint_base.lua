-- ======================================================================
-- Module: hexm.common.base.magic_field.mf_calcpoint_base
...
MFCalcpointBase: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/common/base/magic_field/mf_calcpoint_base.lua:15-18
  __module__: "hexm/common/base/magic_field/mf_calcpoint_base.lua"
...
-- End of hexm.common.base.magic_field.mf_calcpoint_base