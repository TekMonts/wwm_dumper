...
AnimActionTimeLine: class {
  ...
  __components__: instance {
    ...
    1: class {
      ...
      __module__: "hexm/common/anim_action/anim_action_timeline_members/imp_handlers.lua"
    ...
    2: class {
      -- Metatable:
      --   __tostring: yes
      __module__: "hexm/common/anim_action/anim_action_timeline_members/imp_interrupt.lua"
      ctor: function(...)  -- =[C]
    ...
    3: class {
      ...
      __module__: "hexm/common/anim_action/anim_action_timeline_members/imp_process.lua"
    ...
    4: class {
      -- Metatable:
      --   __tostring: yes
      __module__: "hexm/common/anim_action/anim_action_timeline_members/imp_client.lua"
  ...
  __module__: "hexm/common/anim_action/anim_action_timeline.lua"
