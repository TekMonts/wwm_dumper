...
AnimActionNodePassive: class {
  ...
  __component_finis__: instance {
    ...
    --   __index: table
    --   __tostring: yes
    1: function(arg1)  -- @hexm/common/anim_action/anim_action_node_members/imp_client.lua:19-21
  ...
  __components__: instance {
    ...
    5: class {
      ...
      __module__: "hexm/common/anim_action/anim_action_node_members/imp_interrupt_passive.lua"
  ...
  __module__: "hexm/common/anim_action/anim_action_node_passive.lua"
