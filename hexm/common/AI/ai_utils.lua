...
AI_STATES_MAP: instance {
  ...
  alert: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/AI/ai_states/state_alert.lua"
  ...
  behit: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/AI/ai_states/state_behit.lua"
  ...
  buffcontrol: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/AI/ai_states/state_buffcontrol.lua"
  ...
  die: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/AI/ai_states/state_die.lua"
    on_enter: function(arg1)  -- @hexm/common/AI/ai_states/state_die.lua:13-14
  }
  fight: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/AI/ai_states/state_fight.lua"
    on_enter: function(arg1)  -- @hexm/common/AI/ai_states/state_fight.lua:13-14
  }
  idle: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/AI/ai_states/state_idle.lua"
  ...
  kidnap: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/AI/ai_states/state_kidnap.lua"
    on_leave: function(arg1, arg2)  -- @hexm/common/AI/ai_states/state_kidnap.lua:14-21
  }
  return: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/AI/ai_states/state_return.lua"
    on_enter: function(arg1)  -- @hexm/common/AI/ai_states/state_return.lua:13-16
  }
  revive: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/common/AI/ai_states/state_revive.lua"
...
DEFAULT_STATE: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/common/AI/ai_states/state_base.lua"
  __tostring: nil
...
get_entity_relative_offset_pos_yaw: function(arg1, arg2)  -- @hexm/common/AI/ai_utils.lua:138-155

replace_entity_effect: function(arg1, arg2)  -- @hexm/common/AI/ai_utils.lua:98-136
