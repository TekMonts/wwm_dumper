-- ======================================================================
-- Module: hexm.client.ui.view.view_logic_component.common_color_picker_horizontal_vlc
...
CommonColorPickerHorizontalVLC: class {
  -- Metatable:
  --   __tostring: yes
...
-- End of hexm.client.ui.view.view_logic_component.common_color_picker_horizontal_vlc