-- ======================================================================
-- Module: hexm.client.ui.view.view_logic_component.auto_size_by_text_child_vlc
...
-- End of hexm.client.ui.view.view_logic_component.auto_size_by_text_child_vlc