...
TaskShijieguanFabuPageView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
...
-- End of hexm.client.ui.generated_view.task_shijieguan_fabu_page_view