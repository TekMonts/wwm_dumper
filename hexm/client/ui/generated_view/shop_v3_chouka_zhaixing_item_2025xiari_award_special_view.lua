...
ShopV3ChoukaZhaixingItem2025xiariAwardSpecialView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
  ...
  NODES_INDEX_PATH: instance {
    ...
    image_award_bg_jianbian: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.shop_v3_chouka_zhaixing_item_2025xiari_award_special_view