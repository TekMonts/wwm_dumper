...
FaceCreateV3Lv3ZhuangrongShanseItem2View: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
  ...
  NODES_INDEX_PATH: instance {
    ...
    template_cur_item: list ["", <nested>]
    text_title_unused_0: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.face_create_v3_lv3_zhuangrong_shanse_item2_view