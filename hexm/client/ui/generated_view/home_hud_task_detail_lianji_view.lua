...
HomeHudTaskDetailLianjiView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
  ...
  NODES_INDEX_PATH: instance {
    ...
    text_task_location: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.home_hud_task_detail_lianji_view