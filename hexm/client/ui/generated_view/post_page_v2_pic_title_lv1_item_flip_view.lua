-- ======================================================================
-- Module: hexm.client.ui.generated_view.post_page_v2_pic_title_lv1_item_flip_view
...
PostPageV2PicTitleLv1ItemFlipView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: <list>
  ...
  NODES_INDEX_PATH: instance {
    ...
    --   __tostring: yes
    button: list ["", <nested>]
    image_all_bg_hover: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.post_page_v2_pic_title_lv1_item_flip_view