-- ======================================================================
-- Module: hexm.client.ui.generated_view.home_buff_v2_liupaita_qianghua_lan_view
...
HomeBuffV2LiupaitaQianghuaLanView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
...
-- End of hexm.client.ui.generated_view.home_buff_v2_liupaita_qianghua_lan_view