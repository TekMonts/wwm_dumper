-- ======================================================================
-- Module: hexm.client.ui.generated_view.home_point_guide_v2_baxituan_view
...
HomePointGuideV2BaxituanView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
  ...
  NODES_INDEX_PATH: instance {
    ...
    node_gezi: list ["", <nested>]
    node_point: list ["", <circular>]
    panel_guide: list ["", <circular>]
    progresstimer_grey: list ["", <nested>]
    progresstimer_red: list ["", <circular>]
    splendor_bg_glow_1_3: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.home_point_guide_v2_baxituan_view