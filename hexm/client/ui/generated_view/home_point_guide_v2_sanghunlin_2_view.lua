...
HomePointGuideV2Sanghunlin2View: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
  ...
  NODES_INDEX_PATH: instance {
    ...
    node_button_close_guide_stuff_pos: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.home_point_guide_v2_sanghunlin_2_view