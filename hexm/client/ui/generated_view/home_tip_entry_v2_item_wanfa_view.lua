...
HomeTipEntryV2ItemWanfaView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
  ...
  NODES_INDEX_PATH: instance {
    ...
    particle_yezi_1: list ["", <nested>]
    particle_yezi_2: list ["", <circular>]
    root_attach: list ["", <circular>]
    splendor_Polar: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.home_tip_entry_v2_item_wanfa_view