...
HomeHudMyBloodPcView: class {
  ...
  ANIMS: instance {
    ...
    17: "vx_dying_loop"
    18: "vx_neili_yishang_in"
    19: "vx_neili_yishang_out"
    20: "vx_lock_in"
    21: "vx_lock_out"
    22: "vx_lock_loop"
    23: "vx_lock_eat"
  ...
  DYNAMIC_LOAD_TEMPLATE: instance {
    ...
    template_sanghunlin_hudun_view: instance {
      ...
      2: class {
        ...
        VLC: nil
        __index: nil
        __module__: "hexm/client/ui/generated_view/sanghunlin_hud_hudun_view.lua"
        ...
        ctor: function(arg1, arg2)  -- @hexm/client/ui/generated_view/sanghunlin_hud_hudun_view.lua:71-84
        destroy_object: function(arg1)  -- @hexm/client/ui/generated_view/sanghunlin_hud_hudun_view.lua:102-105
        ...
        on_create: function(arg1)  -- @hexm/client/ui/generated_view/sanghunlin_hud_hudun_view.lua:90-92
        on_csb_unloaded: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:38-46
        on_preload_callback: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:525-541
        on_set_window: function(arg1, arg2, arg3)  -- @hexm/client/ui/generated_view/sanghunlin_hud_hudun_view.lua:94-96
        play_anim: function(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10)  -- @hexm/client/ui/struct/csb_interface.lua:115-197
        play_anim_to: function(arg1, arg2, arg3, arg4)  -- @hexm/client/ui/struct/csb_interface.lua:366-392
        remove_dynamic_view: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:91-101
        safe_refresh_layout: function(arg1)  -- @hexm/client/ui/generated_view/sanghunlin_hud_hudun_view.lua:98-100
        seek_other: nil
  ...
  NODES_INDEX_PATH: instance {
    ...
    image_blue_bar_yishang: list ["", <circular>]
    ...
    image_limit_reduce: list ["	", <circular>]
    image_limit_reduce_0: list ["	", <circular>]
    ...
    splendor_SoundNoise_0: list ["	", <circular>]
    ...
    splendor_sweep_bg_0: list ["	", <circular>]
    splendor_sweep_bg_big_0: list ["	", <circular>]
    splendor_sweep_bg_top_0: list ["	", <circular>]
    splendor_upgrade_glow_1_2: list ["", <circular>]
    splendor_upgrade_glow_right: list ["", <circular>]
    template_equip: list ["", <circular>]
    template_liupaita_buff: list ["", <circular>]
    ...
    vx_blood1_full: list ["", <circular>]
    vx_blood_full: list ["", <circular>]
    vx_blood_lack: list ["", <circular>]
    vx_blue1_full: list ["", <circular>]
    vx_blue_full: list ["", <circular>]
    vx_blue_lack: list ["", <circular>]
    vx_blue_shouji: list ["", <circular>]
    vx_boss_kill_glow1: list ["", <circular>]
    vx_buff_in: list ["", <circular>]
    vx_buff_node_add: list ["", <circular>]
    vx_eat_piece_2: list ["	", <circular>]
    vx_eat_piece_3: list ["	", <circular>]
    vx_eat_piece_4: list ["	", <circular>]
    vx_eat_piece_5: list ["	", <circular>]
    vx_eat_piece_6: list ["	", <circular>]
    vx_eat_piece_7: list ["	", <circular>]
    vx_eat_piece_8: list ["	", <circular>]
    vx_glow_2: list ["	", <circular>]
    vx_glow_3: list ["	", <circular>]
    vx_glow_4: list ["	", <circular>]
    vx_glow_in_0: list ["	", <circular>]
    vx_hud_buff_mobile_line: list ["", <circular>]
    vx_hud_buff_mobile_line_0: list ["", <circular>]
    vx_img_pro_dead_blood_glow: list ["", <circular>]
    vx_layout_blood_0: list ["	", <circular>]
    vx_layout_glow: list ["", <circular>]
    vx_layout_interior_line_0: list ["	", <circular>]
    vx_layout_lock_0: list ["	", <circular>]
    vx_lifebar1_light: list ["", <circular>]
    vx_lifebar_light: list ["", <circular>]
    vx_line_2: list ["	", <circular>]
    vx_line_add_0: list ["	", <circular>]
    vx_line_add_l: list ["	", <circular>]
    vx_line_add_r: list ["\n", <circular>]
    vx_lock_0: list ["	", <circular>]
    vx_lock_1: list ["	", <circular>]
    vx_lock_glow_0: list ["	", <circular>]
    vx_lock_glow_1: list ["	", <circular>]
    vx_lock_glow_bg_0: list ["	", <circular>]
    vx_lock_line: list ["	", <circular>]
    vx_lock_line_2: list ["	", <circular>]
    vx_lock_line_3: list ["	", <circular>]
    vx_lock_loop: list ["	", <circular>]
    vx_lock_node: list ["	", <circular>]
    vx_loop_right_1: list ["", <circular>]
    vx_loop_right_2: list ["", <circular>]
    vx_node_pc: list ["", <circular>]
    vx_par_node_0: list ["	", <circular>]
  ...
  REFERENCE_PNG: instance {
    ...
    3: "buff_120_xuanyun_0_0_ui"
    4: "com_body_icon_baoshi_96_0_0_ui"
    5: "com_body_icon_jingli_96_0_0_ui"
    6: "com_btn_circle_bg_hover_0_0_ui"
    7: "com_white_bg2_0_0_ui"
    8: "equipment_deco_diwen_0_0_ui"
    9: "home_blood_bg_0_0_ui"
    10: "home_blood_bg_1_0_0_ui"
    11: "home_blood_guai_shield_over_0_0_ui"
    12: "home_blood_my_nei_bg_0_0_ui"
    13: "home_blood_my_xue_bg_0_0_ui"
    14: "home_blood_my_xue_diao_0_0_ui"
    15: "home_blood_my_xue_pro_0_0_ui"
    16: "home_blood_my_zhangwanshi_reduce_0_0_ui"
    17: "home_blood_shield_player_0_0_ui"
    18: "home_blood_shield_player_over_0_0_ui"
    19: "home_blue_bar_bg_buzu_0_0_ui"
    20: "home_blue_bar_bg_shouji_0_0_ui"
    21: "home_blue_bar_pro_0_0_ui"
    22: "home_blue_my_xue_top_0_0_ui"
    23: "home_hud_icon_shan_0_0_ui"
    24: "home_hud_team_blood_dead_0_0_ui"
    25: "home_hud_team_blood_kong_0_0_ui"
    26: "lightCross_light10"
    27: "lightCross_light2"
    28: "loading_pattern_btn_bg_0_0_ui"
    29: "vx_bangpai_sweep_light_01"
    30: "vx_blood_outline_04"
    31: "vx_boss_kill_glow3"
    32: "vx_chat_select_glow"
    33: "vx_com_tip_string"
    34: "vx_common_glow"
    35: "vx_core_line_base_white_2"
    36: "vx_core_square_outline_01"
    37: "vx_dianxue_xian_02"
    38: "vx_eat_lizi_01_0_0_ui"
    39: "vx_eat_piece_01_0_0_ui"
    40: "vx_eat_piece_02_0_0_ui"
    41: "vx_eat_piece_03_0_0_ui"
    42: "vx_eat_piece_04_0_0_ui"
    43: "vx_eat_piece_05_0_0_ui"
    44: "vx_fenchen_lizi_0_0_ui"
    45: "vx_glow_common"
    46: "vx_home_blood_boss_guigongzi_suo_0_0_ui"
    47: "vx_home_blood_my_zhangwanshi_reduce_gray_0_0_ui"
    48: "vx_hud_buff_mobile_line_white"
    49: "vx_hud_buff_mobile_music_white"
    50: "vx_hud_buff_mobile_splendor_line"
    51: "vx_hud_buff_mobile_splendor_somke"
    52: "vx_hud_juejing_blood_first_bg_right_0_0_ui"
    53: "vx_hud_juejing_blood_loop_first_right"
    54: "vx_hud_juejing_blood_loop_second_right"
    55: "vx_hud_juejing_blood_second_bg_right_0_0_ui"
    56: "vx_hud_juejing_blood_upgrade_first_right"
    57: "vx_hud_juejing_blood_upgrade_second_right"
    58: "vx_light_line_1"
    59: "vx_light_line_3"
    60: "vx_rotation_glow"
    61: "vx_roukou_glow2"
    62: "vx_tansuo_quyu_glow_loop4"
    63: "vx_thin_rectangle_mask2"
    64: "vx_tiaolv_bg_par_rgb"
    65: "vx_toast_glow"
  ...
  VLC: nil
  __index: nil
  __module__: "hexm/client/ui/generated_view/home_hud_my_blood_pc_view.lua"
  _get_timeline: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:275-281
  _load_and_get_timeline: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:224-247
  _load_anim: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:249-273
  _on_anim_event_frame: function(arg1, arg2, arg3)  -- @hexm/client/ui/struct/csb_interface.lua:214-222
  ...
  check_and_play_anim_sound: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:463-470
  check_and_play_anim_stop_sound: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:472-479
  clear_attr_values: function(arg1)  -- @hexm/client/ui/generated_view/home_hud_my_blood_pc_view.lua:545-557
  clear_dynamic_views: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:103-112
  clear_last_frame_callback: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:449-454
  ctor: function(arg1, arg2)  -- @hexm/client/ui/generated_view/home_hud_my_blood_pc_view.lua:482-497
  destroy_object: function(arg1)  -- @hexm/client/ui/generated_view/home_hud_my_blood_pc_view.lua:601-604
  generate_children_view: function(arg1)  -- @hexm/client/ui/generated_view/home_hud_my_blood_pc_view.lua:559-581
  get_anim_info: function(arg1, arg2, arg3)  -- @hexm/client/ui/struct/csb_interface.lua:419-424
  get_anim_sound_key: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:457-461
  get_dynamic_view: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:83-89
  get_frame_internal: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:426-432
  ...
  load_dynamic_view: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:62-74
  load_dynamic_view_safely: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:76-81
  on_create: function(arg1)  -- @hexm/client/ui/generated_view/home_hud_my_blood_pc_view.lua:584-586
  on_csb_unloaded: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:38-46
  on_preload_callback: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:525-541
  on_set_window: function(arg1, arg2, arg3)  -- @hexm/client/ui/generated_view/home_hud_my_blood_pc_view.lua:588-590
  play_anim: function(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10)  -- @hexm/client/ui/struct/csb_interface.lua:115-197
  play_anim_to: function(arg1, arg2, arg3, arg4)  -- @hexm/client/ui/struct/csb_interface.lua:366-392
  remove_dynamic_view: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:91-101
  safe_refresh_layout: function(arg1)  -- @hexm/client/ui/generated_view/home_hud_my_blood_pc_view.lua:592-599
  seek_other: function(arg1)  -- @hexm/client/ui/generated_view/home_hud_my_blood_pc_view.lua:499-543
  set_looping_sound_played: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:209-212
  set_time_speed: function(arg1, arg2, arg3)  -- @hexm/client/ui/struct/csb_interface.lua:442-447
  set_view_fill_screen: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:578-581
  set_view_hide_back_ui: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:583-587
