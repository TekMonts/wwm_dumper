...
JiesuanComLv2FencheAwardV2View: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
...
-- End of hexm.client.ui.generated_view.jiesuan_com_lv2_fenche_award_v2_view