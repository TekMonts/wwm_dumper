...
HomePointGuideV2DisasterView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
  ...
  NODES_INDEX_PATH: instance {
    ...
    --   __index: table
    --   __tostring: yes
    Panel_guide: list ["", <nested>]
    image_arrow_3: list ["", <nested>]
    ...
    progress_timer_3: list ["", <nested>]
    vx_drsp_res: list ["", <circular>]
    vx_zhaohuo: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.home_point_guide_v2_disaster_view