-- ======================================================================
-- Module: hexm.client.ui.generated_view.vx_home_hud_skill_heicaishen_use_view
...
VxHomeHudSkillHeicaishenUseView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
...
-- End of hexm.client.ui.generated_view.vx_home_hud_skill_heicaishen_use_view