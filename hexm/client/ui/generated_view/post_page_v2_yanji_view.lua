-- ======================================================================
-- Module: hexm.client.ui.generated_view.post_page_v2_yanji_view
...
PostPageV2YanjiView: class {
  ...
  NODES_INDEX_PATH: instance {
    ...
    --   __index: table
    --   __tostring: yes
    Panel_left_top_box: list ["", <nested>]
    imageview_qipao_bg: list ["", <nested>]
    imageview_yanji_tips: list ["", <circular>]
    richtext_left_top: list ["", <nested>]
    root_attach: list ["", <circular>]
    text_left_top: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.post_page_v2_yanji_view