...
JinglingTuijianPageView: class {
  ...
  NODES_INDEX_PATH: instance {
    ...
    --   __index: table
    --   __tostring: yes
    button_right_banben: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.jingling_tuijian_page_view