-- ======================================================================
-- Module: hexm.client.ui.generated_view.talk_v3_left_tab_2_head_view
...
TalkV3LeftTab2HeadView: class {
  ...
  CSB_NAME: "UIScript/talk_v3_left_tab_2_head.csb"
  ...
  NODES_INDEX_PATH: instance {
    ...
    --   __tostring: yes
    button: list ["", <nested>]
    button_head_hover: list ["", <circular>]
    image_bg: list ["", <circular>]
    image_bg_line: list ["", <circular>]
    image_head_hover: list ["", <circular>]
    image_hover: list ["", <circular>]
    image_icon_special_state: list ["", <circular>]
    image_icon_voice: list ["", <circular>]
    image_icon_zengli: list ["", <circular>]
    image_left_top_biaoshi: list ["", <circular>]
    image_sel: list ["", <circular>]
    listview_hug: list ["", <nested>]
    listview_hug_2: list ["", <circular>]
    listview_hug_3: list ["", <circular>]
    listview_name: list ["", <circular>]
    node_bg: list ["", <circular>]
    node_head: list ["", <circular>]
    node_zengli: list ["", <circular>]
    particle_big_wide_b_0: list ["", <circular>]
    particle_loop_big_par: list ["", <circular>]
    particle_loop_small_par: list ["", <circular>]
    particle_sel_par: list ["", <circular>]
    root_attach: list ["", <circular>]
    splendor_sel_line: list ["", <nested>]
    splendor_sel_smoke: list ["", <circular>]
    splendor_sweep_box: list ["", <circular>]
    splendor_sweep_box_glow: list ["", <circular>]
    ...
    template_relatin_tag: list ["", <circular>]
    text_liyou: list ["", <circular>]
    text_liyou_2: list ["", <circular>]
    text_name: list ["", <circular>]
    text_name_1: list ["", <circular>]
    vx_layout_sweep: list ["", <nested>]
    vx_loop: list ["", <circular>]
    vx_particle_box: list ["", <circular>]
    vx_pos_head: list ["", <circular>]
    vx_pos_name: list ["", <circular>]
    vx_sel: list ["", <circular>]
    vx_select: list ["", <circular>]
    vx_select_glow: list ["", <circular>]
    vx_select_glow_add: list ["", <circular>]
    vx_sweep_01: list ["", <circular>]
    vx_sweep_02: list ["", <circular>]
    vx_sweep_03: list ["", <circular>]
    vx_sweep_04: list ["", <circular>]
    vx_text_name: list ["", <circular>]
    vx_text_name_2: list ["", <circular>]
    widget_checkbox: list ["", <circular>]
    widget_player: list ["", <circular>]
  }
  REFERENCE_PNG: instance {
    -- Metatable:
    --   __index: table
    ...
    2: "com_icon_144_zengli_box_0_0_ui"
    3: "com_icon_96_liaotian_qunzhu_0_0_ui"
    4: "com_stuff_btn_hover_0_0_ui"
    5: "com_stuff_kong_0_0_ui"
    6: "com_white_bg2_0_0_ui"
    7: "flutter_light"
    8: "head_longmenkezhan_caoli_0_0_ui"
    9: "talk_icon_96_quick_voice_0_0_ui"
    10: "talk_v3_tab_2_sel_0_0_ui"
    11: "vx_chat_select_glow"
    12: "vx_chat_select_line_rgb"
    13: "vx_chat_select_smoke_rgb"
    14: "vx_com_icon_144_zengli_box"
    15: "vx_com_icon_144_zengli_string"
    16: "vx_common_glow"
  ...
  VLC: nil
  __index: nil
  __module__: "hexm/client/ui/generated_view/talk_v3_left_tab_2_head_view.lua"
  _get_timeline: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:275-281
  _load_and_get_timeline: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:224-247
  _load_anim: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:249-273
  _on_anim_event_frame: function(arg1, arg2, arg3)  -- @hexm/client/ui/struct/csb_interface.lua:214-222
  ...
  check_and_play_anim_sound: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:463-470
  check_and_play_anim_stop_sound: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:472-479
  clear_attr_values: function(arg1)  -- @hexm/client/ui/generated_view/talk_v3_left_tab_2_head_view.lua:239-256
  clear_dynamic_views: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:103-112
  clear_last_frame_callback: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:449-454
  ctor: function(arg1, arg2)  -- @hexm/client/ui/generated_view/talk_v3_left_tab_2_head_view.lua:174-190
  destroy_object: function(arg1)  -- @hexm/client/ui/generated_view/talk_v3_left_tab_2_head_view.lua:323-326
  generate_children_view: function(arg1)  -- @hexm/client/ui/generated_view/talk_v3_left_tab_2_head_view.lua:258-279
  get_anim_info: function(arg1, arg2, arg3)  -- @hexm/client/ui/struct/csb_interface.lua:419-424
  get_anim_sound_key: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:457-461
  get_dynamic_view: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:83-89
  get_frame_internal: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:426-432
  ...
  get_window_out_anim: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:625-627
  has_anim_playing: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:399-411
  init_platform_diffs: function(arg1)  -- @hexm/client/ui/generated_view/talk_v3_left_tab_2_head_view.lua:281-306
  is_anim_exists: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:413-417
  is_anim_playing: function(arg1, arg2, arg3)  -- @hexm/client/ui/struct/csb_interface.lua:394-397
  is_in_anim_looping: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:199-202
  jump_to_anim_frame: function(arg1, arg2, arg3, arg4)  -- @hexm/client/ui/struct/csb_interface.lua:345-359
  ...
  load_dynamic_view: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:62-74
  load_dynamic_view_safely: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:76-81
  on_create: function(arg1)  -- @hexm/client/ui/generated_view/talk_v3_left_tab_2_head_view.lua:308-310
  on_csb_unloaded: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:38-46
  on_preload_callback: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:525-541
  on_set_window: function(arg1, arg2, arg3)  -- @hexm/client/ui/generated_view/talk_v3_left_tab_2_head_view.lua:312-314
  play_anim: function(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10)  -- @hexm/client/ui/struct/csb_interface.lua:115-197
  play_anim_to: function(arg1, arg2, arg3, arg4)  -- @hexm/client/ui/struct/csb_interface.lua:366-392
  remove_dynamic_view: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:91-101
  safe_refresh_layout: function(arg1)  -- @hexm/client/ui/generated_view/talk_v3_left_tab_2_head_view.lua:316-321
  seek_other: function(arg1)  -- @hexm/client/ui/generated_view/talk_v3_left_tab_2_head_view.lua:192-237
  set_looping_sound_played: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:209-212
  set_time_speed: function(arg1, arg2, arg3)  -- @hexm/client/ui/struct/csb_interface.lua:442-447
  set_view_fill_screen: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:578-581
  set_view_hide_back_ui: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:583-587
...
-- End of hexm.client.ui.generated_view.talk_v3_left_tab_2_head_view