-- ======================================================================
-- Module: hexm.client.ui.generated_view.photo_main_juzu_bianyan_btn_lefttop_view
...
PhotoMainJuzuBianyanBtnLefttopView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: <list>
  ...
  NODES_INDEX_PATH: instance {
    ...
    --   __index: table
    --   __tostring: yes
    button_act: list ["", <nested>]
    button_biayan: list ["", <circular>]
    image_icon_act_nml: list ["", <nested>]
    ...
    node_left_top: list ["", <nested>]
    root_attach: list ["", <circular>]
    text_act_nml: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.photo_main_juzu_bianyan_btn_lefttop_view