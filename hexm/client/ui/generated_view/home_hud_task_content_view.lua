...
HomeHudTaskContentView: class {
  ...
  NODES_INDEX_PATH: instance {
    ...
    node_task_progress_num_yellow: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.home_hud_task_content_view