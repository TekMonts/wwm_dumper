-- ======================================================================
-- Module: hexm.client.ui.generated_view.home_buff_v2_liupaita_qianghua_view
...
HomeBuffV2LiupaitaQianghuaView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
...
-- End of hexm.client.ui.generated_view.home_buff_v2_liupaita_qianghua_view