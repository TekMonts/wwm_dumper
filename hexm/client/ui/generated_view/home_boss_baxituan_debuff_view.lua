-- ======================================================================
-- Module: hexm.client.ui.generated_view.home_boss_baxituan_debuff_view
...
HomeBossBaxituanDebuffView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
...
-- End of hexm.client.ui.generated_view.home_boss_baxituan_debuff_view