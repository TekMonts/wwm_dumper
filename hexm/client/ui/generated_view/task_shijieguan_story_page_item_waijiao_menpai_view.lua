-- ======================================================================
-- Module: hexm.client.ui.generated_view.task_shijieguan_story_page_item_waijiao_menpai_view
...
TaskShijieguanStoryPageItemWaijiaoMenpaiView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: <list>
  CSB_NAME: "UIScript/task_shijieguan_story_page_item_waijiao_menpai.csb"
  ...
  NODES_INDEX_PATH: instance {
    ...
    --   __index: table
    --   __tostring: yes
    button_green: list ["", <nested>]
    button_menpai: list ["", <circular>]
    button_red: list ["", <circular>]
    imageview_bg: list ["", <circular>]
    imageview_bg_1: list ["", <circular>]
    imageview_green: list ["", <circular>]
    imageview_green_bg: list ["", <circular>]
    imageview_green_hover: list ["", <circular>]
    imageview_hover: list ["	", <circular>]
    imageview_lock: list ["", <circular>]
    imageview_press: list ["", <circular>]
    imageview_red: list ["", <circular>]
    imageview_red_hover: list ["", <circular>]
    imageview_zan: list ["", <circular>]
    imageview_zan_1: list ["", <circular>]
    layout_bg: list ["", <nested>]
    listview_red: list ["", <nested>]
    loadingbar_green: list ["", <nested>]
    loadingbar_red: list ["", <circular>]
    root_attach: list ["", <circular>]
    template_focus_sel_button_menpai: list ["", <circular>]
    template_key_green: list ["", <circular>]
    template_key_red: list ["", <circular>]
    template_redpoint: list ["\n", <circular>]
    text_green: list ["", <circular>]
    text_green_num: list ["", <circular>]
    text_green_zan: list ["", <circular>]
    text_lock: list ["", <circular>]
    text_name: list ["", <circular>]
    text_red: list ["", <circular>]
    text_red_num: list ["", <circular>]
    text_red_zan: list ["", <circular>]
    text_right: list ["", <circular>]
    text_right_guanxi: list ["", <circular>]
    widget_bar: list ["", <circular>]
    widget_lock: list ["", <circular>]
    widget_right_guanxi: list ["", <circular>]
  }
  REFERENCE_PNG: instance {
    -- Metatable:
    --   __index: table
    ...
    4: "icon_96_dianzan_0_0_ui"
    5: "task_shijieguan_banner_tianquan_2_0_0_ui"
    6: "task_shijieguan_btn_hover_0_0_ui"
    7: "task_shijieguan_pro_top_0_0_ui"
    8: "task_shijieguan_toupiao_btn_0_0_ui"
  }
  TAGS: <dict>
  VLC: nil
  __index: nil
  ...
  check_and_play_anim_sound: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:455-462
  check_and_play_anim_stop_sound: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:464-471
  clear_attr_values: function(arg1)  -- @hexm/client/ui/generated_view/task_shijieguan_story_page_item_waijiao_menpai_view.lua:257-328
  clear_dynamic_views: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:103-112
  clear_last_frame_callback: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:441-446
  ctor: function(arg1, arg2)  -- @hexm/client/ui/generated_view/task_shijieguan_story_page_item_waijiao_menpai_view.lua:126-142
  destroy_object: function(arg1)  -- @hexm/client/ui/generated_view/task_shijieguan_story_page_item_waijiao_menpai_view.lua:506-509
  generate_children_view: function(arg1)  -- @hexm/client/ui/generated_view/task_shijieguan_story_page_item_waijiao_menpai_view.lua:330-361
  get_anim_info: function(arg1, arg2, arg3)  -- @hexm/client/ui/struct/csb_interface.lua:411-416
  get_anim_sound_key: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:449-453
  get_dynamic_view: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:83-89
  get_frame_internal: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:418-424
  ...
  get_window_out_anim: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:617-619
  has_anim_playing: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:395-403
  init_platform_diffs: function(arg1)  -- @hexm/client/ui/generated_view/task_shijieguan_story_page_item_waijiao_menpai_view.lua:362-490
  is_anim_exists: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:405-409
  is_anim_playing: function(arg1, arg2, arg3)  -- @hexm/client/ui/struct/csb_interface.lua:390-393
  is_in_anim_looping: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:199-202
  jump_to_anim_frame: function(arg1, arg2, arg3, arg4)  -- @hexm/client/ui/struct/csb_interface.lua:342-355
  ...
  load_dynamic_view: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:62-74
  load_dynamic_view_safely: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:76-81
  on_create: function(arg1)  -- @hexm/client/ui/generated_view/task_shijieguan_story_page_item_waijiao_menpai_view.lua:492-494
  on_csb_unloaded: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:38-46
  on_preload_callback: function(arg1)  -- @hexm/client/ui/struct/csb_interface.lua:517-533
  on_set_window: function(arg1, arg2, arg3)  -- @hexm/client/ui/generated_view/task_shijieguan_story_page_item_waijiao_menpai_view.lua:496-498
  play_anim: function(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10)  -- @hexm/client/ui/struct/csb_interface.lua:115-197
  play_anim_to: function(arg1, arg2, arg3, arg4)  -- @hexm/client/ui/struct/csb_interface.lua:362-388
  remove_dynamic_view: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:91-101
  safe_refresh_layout: function(arg1)  -- @hexm/client/ui/generated_view/task_shijieguan_story_page_item_waijiao_menpai_view.lua:500-504
  seek_other: function(arg1)  -- @hexm/client/ui/generated_view/task_shijieguan_story_page_item_waijiao_menpai_view.lua:144-255
  set_looping_sound_played: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:209-212
  set_time_speed: function(arg1, arg2, arg3)  -- @hexm/client/ui/struct/csb_interface.lua:434-439
  set_view_fill_screen: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:570-573
  set_view_hide_back_ui: function(arg1, arg2)  -- @hexm/client/ui/struct/csb_interface.lua:575-579
...
-- End of hexm.client.ui.generated_view.task_shijieguan_story_page_item_waijiao_menpai_view