-- ======================================================================
-- Module: hexm.client.ui.generated_view.photo_main_juzu_midlist_view
...
PhotoMainJuzuMidlistView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: <list>
...
-- End of hexm.client.ui.generated_view.photo_main_juzu_midlist_view