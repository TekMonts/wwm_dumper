-- ======================================================================
-- Module: hexm.client.ui.generated_view.shop_chouka_bg_yueshi_nan_oversea_view
...
ShopChoukaBgYueshiNanOverseaView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
  ...
  NODES_INDEX_PATH: instance {
    ...
    --   __index: table
    --   __tostring: yes
    image_bg_heming_1_nan: list ["", <nested>]
...
-- End of hexm.client.ui.generated_view.shop_chouka_bg_yueshi_nan_oversea_view