...
FaceCreateV3Lv3MakeupEditMobileView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: <list>
...
-- End of hexm.client.ui.generated_view.face_create_v3_lv3_makeup_edit_mobile_view