-- ======================================================================
-- Module: hexm.client.ui.generated_view.quanju_liupai_jindu_item_xinfa_view
...
QuanjuLiupaiJinduItemXinfaView: class {
  -- Metatable:
  --   __tostring: yes
  ANIMS: instance {
    -- Metatable:
...
-- End of hexm.client.ui.generated_view.quanju_liupai_jindu_item_xinfa_view