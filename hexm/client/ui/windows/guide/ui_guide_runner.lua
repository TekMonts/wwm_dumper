...
GUIDE_UI_MODE_TO_WIN: table {
  ...
  2: class {
    ...
    __module__: "hexm/client/ui/windows/guide/guide_picture_window.lua"
  ...
  3: class {
    ...
    SELF_SORTING_LAYER: 40
    VIEW_HIDE_SCENE: true
    __module__: "hexm/client/ui/windows/guide/guide_video_window.lua"
  ...
  6: class {
    ...
    __module__: "hexm/client/ui/windows/guide/guide_pc_key_window.lua"
...
GuidePeriodRunner: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/ui/windows/guide/ui_guide_runner.lua"
