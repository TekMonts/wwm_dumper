-- ======================================================================
-- Module: hexm.client.ui.windows.task.home_task_item.home_call_online_item
...
CallOnlineTipController: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/ui/windows/task/home_task_item/home_call_online_item.lua"
  init: function(arg1, arg2)  -- @hexm/client/ui/windows/task/home_task_item/home_call_online_item.lua:106-126
}

CallOnlineTipWindow: class {
  -- Metatable:
  --   __tostring: yes
  LAYER_ZORDER: 4
  USE_BACK_BTN: true
  __module__: "hexm/client/ui/windows/task/home_task_item/home_call_online_item.lua"
  ctor: function(arg1)  -- @hexm/client/ui/windows/task/home_task_item/home_call_online_item.lua:93-96
  init: function(arg1, arg2)  -- @hexm/client/ui/windows/task/home_task_item/home_call_online_item.lua:98-101
}

HomeCallOnlineItem: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/ui/windows/task/home_task_item/home_call_online_item.lua"
...
-- End of hexm.client.ui.windows.task.home_task_item.home_call_online_item