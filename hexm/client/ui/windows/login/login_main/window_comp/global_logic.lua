-- ======================================================================
-- Module: hexm.client.ui.windows.login.login_main.window_comp.global_logic
...
-- End of hexm.client.ui.windows.login.login_main.window_comp.global_logic