-- ======================================================================
-- Module: hexm.client.ui.windows.store.common.mount_upgrade_mat_controller
...
MountUpgradeMatController: class {
  -- Metatable:
  --   __tostring: yes
...
StuffItem: class {
  ...
  --   __tostring: yes
  __module__: "hexm/client/ui/windows/store/common/mount_upgrade_mat_controller.lua"
  update_content: function(arg1, arg2, arg3)  -- @hexm/client/ui/windows/store/common/mount_upgrade_mat_controller.lua:309-321
}


-- End of hexm.client.ui.windows.store.common.mount_upgrade_mat_controller