-- ======================================================================
-- Module: hexm.client.ui.windows.face.face_mobile.face_makeup_color_controller_mobile
...
MakeupColorListControllerMobile: class {
  -- Metatable:
  --   __tostring: yes
...
-- End of hexm.client.ui.windows.face.face_mobile.face_makeup_color_controller_mobile