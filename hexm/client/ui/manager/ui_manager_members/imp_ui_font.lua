-- ======================================================================
-- Module: hexm.client.ui.manager.ui_manager_members.imp_ui_font
...
MOBILE_FONT_MAP: instance {
  -- Metatable:
  --   __index: table
  --   __tostring: yes
  FZSKBXKJW.TTF: "FZSKBXKJW_mobile.TTF"
}
...
-- End of hexm.client.ui.manager.ui_manager_members.imp_ui_font