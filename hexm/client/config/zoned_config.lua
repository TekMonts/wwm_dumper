...
conf_items: function()  -- @hexm/client/config/zoned_config.lua:323

conf_zones: function()  -- @hexm/client/config/zoned_config.lua:321
...
zoned_conf_items: function()  -- @hexm/client/config/zoned_config.lua:325
