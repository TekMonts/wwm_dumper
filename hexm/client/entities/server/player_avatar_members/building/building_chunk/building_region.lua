-- ======================================================================
-- Module: hexm.client.entities.server.player_avatar_members.building.building_chunk.building_region
...
BuildingRegion: class {
  ...
  __components__: instance {
    ...
    1: class {
      -- Metatable:
      --   __tostring: yes
      debug_show_area: function(arg1)  -- @hexm/client/entities/server/player_avatar_members/building/building_chunk/building_region_members/imp_debug_show.lua:14-16
      debug_show_area_clear: function(arg1)  -- @hexm/client/entities/server/player_avatar_members/building/building_chunk/building_region_members/imp_debug_show.lua:18-20
    }
    2: class {
      -- Metatable:
      --   __tostring: yes
      calc_cur_distance: function(arg1, arg2)  -- @hexm/client/entities/server/player_avatar_members/building/building_chunk/building_region_members/imp_distance.lua:14-17
    }
    3: <class>
  }
...
-- End of hexm.client.entities.server.player_avatar_members.building.building_chunk.building_region