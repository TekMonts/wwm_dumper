...
Tree: class {
  ...
  __component_normal_dict__: table {
    ...
    <class TreeMember at 000001922F7C6790>: true
    <class TreeMember at 000001922F7C6A20>: true
    <class TreeMember at 000001922F7C71D0>: true
    <class TreeMember at 000001922F7CA7A0>: true
    <class TreeMember at 000001922F7CC8F0>: true
    <class VisibilityBase at 00000192108D66C0>: true
  }
  __components__: list [<nested>, <circular>, <nested>, <circular>, <circular>, <circular>, <circular>, <nested>, <circular>, <circular>, <circular>, <circular>, <circular>, <circular>, <circular>, <circular>, <circular>, <circular>]
  __module__: "hexm/client/entities/local/tree.lua"
