-- ======================================================================
-- Module: hexm.client.entities.local.ai_avatar_members.imp_ailab_landform
...
AIAvatarMember: class {
  -- Metatable:
  --   __tostring: yes
  __enter_space_component__: function(arg1, arg2)  -- @hexm/client/entities/local/ai_avatar_members/imp_ailab_landform.lua:39-44
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/ai_avatar_members/imp_ailab_landform.lua:33-37
  __module__: "hexm/client/entities/local/ai_avatar_members/imp_ailab_landform.lua"
...
-- End of hexm.client.entities.local.ai_avatar_members.imp_ailab_landform