-- ======================================================================
-- Module: hexm.client.entities.local.ai_avatar_members.imp_swim
...
AIAvatarMember: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/ai_avatar_members/imp_swim.lua:11-13
  __module__: "hexm/client/entities/local/ai_avatar_members/imp_swim.lua"
  __skeleton_ready_component__: function(arg1)  -- @hexm/client/entities/local/ai_avatar_members/imp_swim.lua:15-17
  ctor: function(...)  -- =[C]
...
-- End of hexm.client.entities.local.ai_avatar_members.imp_swim