-- ======================================================================
-- Module: hexm.client.entities.local.ai_avatar_members.imp_weapon
...
AIAvatarMember: class {
  ...
  __module__: "hexm/client/entities/local/ai_avatar_members/imp_weapon.lua"
  __skeleton_ready_component__: function(arg1)  -- @hexm/client/entities/local/ai_avatar_members/imp_weapon.lua:18-23
...
-- End of hexm.client.entities.local.ai_avatar_members.imp_weapon