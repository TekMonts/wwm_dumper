-- ======================================================================
-- Module: hexm.client.entities.local.ai_avatar_members.imp_calcpoint
...
AIAvatarMember: class {
  -- Metatable:
  --   __tostring: yes
  __enter_space_component__: function(arg1)  -- @hexm/client/entities/local/ai_avatar_members/imp_calcpoint.lua:11-13
  __module__: "hexm/client/entities/local/ai_avatar_members/imp_calcpoint.lua"
...
-- End of hexm.client.entities.local.ai_avatar_members.imp_calcpoint