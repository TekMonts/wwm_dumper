-- ======================================================================
-- Module: hexm.client.entities.local.ai_avatar_members.imp_skill_cd
...
AIAvatarMember: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/ai_avatar_members/imp_skill_cd.lua:12-14
  __module__: "hexm/client/entities/local/ai_avatar_members/imp_skill_cd.lua"
...
-- End of hexm.client.entities.local.ai_avatar_members.imp_skill_cd