-- ======================================================================
-- Module: hexm.client.entities.local.ai_avatar_members.imp_storyline
...
AIAvatarMember: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/ai_avatar_members/imp_storyline.lua:10-15
  __module__: "hexm/client/entities/local/ai_avatar_members/imp_storyline.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/ai_avatar_members/imp_storyline.lua:17-19
  __skeleton_ready_component__: function(arg1)  -- @hexm/client/entities/local/ai_avatar_members/imp_storyline.lua:21-23
...
-- End of hexm.client.entities.local.ai_avatar_members.imp_storyline