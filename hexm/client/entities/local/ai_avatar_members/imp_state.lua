-- ======================================================================
-- Module: hexm.client.entities.local.ai_avatar_members.imp_state
...
AIAvatarMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/ai_avatar_members/imp_state.lua"
...
-- End of hexm.client.entities.local.ai_avatar_members.imp_state