-- ======================================================================
-- Module: hexm.client.entities.local.grid_building_members.imp_rigidbody
...
GridBuildingMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/grid_building_members/imp_rigidbody.lua:19-22
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/grid_building_members/imp_rigidbody.lua:14-17
  __module__: "hexm/client/entities/local/grid_building_members/imp_rigidbody.lua"
...
-- End of hexm.client.entities.local.grid_building_members.imp_rigidbody