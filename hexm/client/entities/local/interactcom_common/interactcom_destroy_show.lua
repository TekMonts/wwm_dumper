-- ======================================================================
-- Module: hexm.client.entities.local.interactcom_common.interactcom_destroy_show
...
InteractComDestroyShow: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/interactcom_common/interactcom_destroy_show.lua"
...
-- End of hexm.client.entities.local.interactcom_common.interactcom_destroy_show