-- ======================================================================
-- Module: hexm.client.entities.local.fake_avatar
...
FakeAvatar: class {
  ...
  __all_declared_listens: table {
    common: table {
      456: table {
        _colorize_on_enter_battle: 26
      }
      457: table {
        _colorize_on_leave_battle: 26
      }
      561: table {
        _play_sound_on_entity_dead: 23
      }
      593: table {
        _set_effect_visible_by_weapon: 14
      }
      612: table {
        _accessory_handle_render_state_change: 30
        _weapon_handle_render_state_change: 18
      }
      675: table {
        _colorize_on_start_interacting: 26
      }
      676: table {
        _colorize_on_end_interacting: 26
      }
      695: table {
        _colorize_on_interact_comp_handlers_changed: 26
      }
      862: table {
        _colorize_on_start_being_trace_target: 26
      }
      863: table {
        _colorize_on_stop_being_trace_target: 26
      }
      1547: table {
        _colorize_on_became_chosen_target: 26
        _on_billboard_refresh_mode_choose_target: 19
      }
      1548: table {
        _colorize_on_stop_became_chosen_target: 26
        _on_billboard_refresh_mode_choose_target: 19
      }
      2746: table {
        _scene_node_on_server_show: 22
      }
      2013-1011: table {
        _on_guise_hair_changed: 17
      }
      2013-3011: table {
        _on_guise_cloth_changed: 17
      }
      2013-3031: table {
        _on_guise_cloak_changed: 17
      }
      2013-8010: table {
        _on_guise_cloth_top_changed: 17
      }
      2013-9010: table {
        _on_guise_cloth_bottom_changed: 17
      }
    }
    cue: table {
      57: table {
        _on_weapon_anim_cue: 18
      }
      67: table {
        _on_cue_hide_weapon: 18
      }
      131: table {
        _cue_adjust_cloth_max_dis_scale: 24
      }
      132: table {
        _cue_switch_cloth: 24
      }
      340: table {
        _on_change_weapon_tach_cue: 18
      }
      341: table {
        _on_set_weapon_target_cue: 18
      }
      772: table {
        _on_weapon_change_link_cue: 18
      }
      773: table {
        _on_cue_active_weapon_play_anim: 18
      }
      777: table {
        _on_weapon_tach_entity_cue: 18
      }
      778: table {
        _on_weapon_tach_anim_cue: 18
      }
      782: table {
        _on_weapon_change_link_anim_cue: 18
      }
      787: table {
        _on_weapon_forbit_point_change_cue: 18
      }
      812: table {
        _on_cue_set_weapon_default_link: 18
      }
      813: table {
        _on_cue_load_temp_weapon: 18
      }
      820: table {
        _on_cue_reset_default_link: 18
      }
      2082: table {
        on_cue_start_vat_dissolve: 20
      }
    }
    data: table {
      AvatarCombat-in_battle: table {
        _on_billboard_refresh_mode: 19
      }
      NpcCombat-in_battle: table {
        _on_billboard_refresh_mode: 19
      }
      WeaponFollowInfo: table {
        _on_weapon_follow_info_change: 18
      }
      Weapons-active_weapon_no: table {
        _handle_active_weapon_changed: 18
      }
      Weapons-show_weapons: table {
        _handle_show_weapons_changed: 18
      }
      billboard_item: table {
        _handle_billboard_item_change: 19
      }
    }
  }
  __component_func_dict__: table {
    ...
    load_model_over: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
    on_fast_recycle: list [<nested>, <nested>]
    on_fast_reuse: list [<nested>, <nested>, <nested>, <nested>]
    on_reconnected: list [<nested>]
    on_recycled: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
    ...
    pre_fini: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
    pre_reuse: list [<nested>, <nested>]
    set_view_visible: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
    set_visible: list [<nested>, <nested>]
    skeleton_ready: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
  ...
  __component_normal_dict__: table {
    ...
    <class FakeAvatarMember at 0000023895A7B9F0>: true
    <class FakeAvatarMember at 0000023895A7DDD0>: true
    <class FakeAvatarMember at 0000023895A7E060>: true
    <class FakeAvatarMember at 0000023895A7E580>: true
    <class FakeAvatarMember at 0000023895A7FC90>: true
    <class FakeAvatarMember at 0000023895A7FF20>: true
    <class FakeAvatarMember at 0000023895A80BF0>: true
    <class FakeAvatarMember at 0000023895A818C0>: true
    <class FakeAvatarMember at 0000023895A82FD0>: true
    <class FakeAvatarMember at 0000023895A83260>: true
    <class HexPluginBase at 000002388B3ABC90>: true
    <class HideEntityBase at 0000023888578AF0>: true
    <class NpcMember at 0000023895A7E2F0>: true
  ...
  __components__: list [<nested>, <circular>, <nested>, <circular>, <circular>, <circular>, <circular>, <nested>, <circular>, <circular>, <circular>, <class>, <circular>, <circular>, <circular>, <circular>, <circular>, <circular>, <circular>, <circular>, ... +10 more]
  ...
  _add_accessory_entity: function(arg1, arg2, ...)  -- @hexm/client/entities/local/fake_avatar_members/imp_accessory.lua:15-21
  ...
  _on_billboard_inited: function(arg1)  -- @hexm/client/entities/local/fake_avatar_members/imp_billboard.lua:25-29
  ...
  add_billboard_by_msg: function(arg1, arg2)  -- @hexm/client/entities/local/fake_avatar_members/imp_billboard.lua:56-127
  ...
  apply_player_face: function(arg1, arg2, arg3)  -- @hexm/client/entities/local/fake_avatar_members/imp_face.lua:25-27
  apply_player_face_data: function(arg1, arg2)  -- @hexm/client/entities/local/fake_avatar_members/imp_face.lua:29-32
  apply_player_guise: function(arg1, arg2, arg3)  -- @hexm/client/entities/local/fake_avatar_members/imp_guise.lua:25-27
  apply_player_guise_data: function(arg1, arg2)  -- @hexm/client/entities/local/fake_avatar_members/imp_guise.lua:29-33
  apply_player_weapon: function(arg1, arg2, arg3)  -- @hexm/client/entities/local/fake_avatar_members/imp_weapon.lua:25-27
  apply_player_weapon_data: function(arg1, arg2)  -- @hexm/client/entities/local/fake_avatar_members/imp_weapon.lua:29-43
  ...
  ctor: function(arg1, arg2, arg3, arg4)  -- @hexm/client/entities/local/fake_avatar.lua:20-23
  ...
  entity_play_model_effect: function(arg1, arg2)  -- @hexm/client/entities/local/fake_avatar_members/imp_effect.lua:24-30
  ...
  get_avatar_data: function(arg1)  -- @hexm/client/entities/local/fake_avatar.lua:40-46
  ...
  get_body_type: function(arg1)  -- @hexm/client/entities/local/fake_avatar.lua:36-38
  ...
  get_common_anim_graph: function(arg1)  -- @hexm/client/entities/local/fake_avatar_members/imp_anim.lua:15-17
  ...
  get_guise_info: function(arg1)  -- @hexm/client/entities/local/fake_avatar_members/imp_guise.lua:43-50
  ...
  get_model_no: function(arg1)  -- @hexm/client/entities/local/fake_avatar.lua:25-30
  ...
  get_school_no: function(arg1)  -- @hexm/client/entities/local/fake_avatar.lua:32-34
  ...
  play_visual_action: function(arg1)  -- @hexm/client/entities/local/fake_avatar_members/imp_anim_action.lua:24-29
  play_visual_msg: function(arg1)  -- @hexm/client/entities/local/fake_avatar_members/imp_billboard.lua:31-36
  play_visual_record: function(arg1)  -- @hexm/client/entities/local/fake_avatar_members/imp_billboard.lua:38-48
  ...
  refresh_cur_guise: function(arg1)  -- @hexm/client/entities/local/fake_avatar_members/imp_guise.lua:35-41
  ...
  should_use_cloth: function(arg1)  -- @hexm/client/entities/local/fake_avatar_members/imp_cloth.lua:10-12
  ...
  stop_visual_record: function(arg1)  -- @hexm/client/entities/local/fake_avatar_members/imp_billboard.lua:50-54
...
-- End of hexm.client.entities.local.fake_avatar