-- ======================================================================
-- Module: hexm.client.entities.local.billboard_entity_members.imp_visibility
...
BillboardEntityMember: class {
  -- Metatable:
  --   __tostring: yes
  __enter_space_component__: function(arg1, arg2)  -- @hexm/client/entities/local/billboard_entity_members/imp_visibility.lua:21-27
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/billboard_entity_members/imp_visibility.lua:16-19
  __module__: "hexm/client/entities/local/billboard_entity_members/imp_visibility.lua"
...
-- End of hexm.client.entities.local.billboard_entity_members.imp_visibility