-- ======================================================================
-- Module: hexm.client.entities.local.dice_members.imp_effect
...
DiceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/dice_members/imp_effect.lua:25-33
  __module__: "hexm/client/entities/local/dice_members/imp_effect.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/dice_members/imp_effect.lua:12-23
...
-- End of hexm.client.entities.local.dice_members.imp_effect