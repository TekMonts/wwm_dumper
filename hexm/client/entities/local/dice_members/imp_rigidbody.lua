-- ======================================================================
-- Module: hexm.client.entities.local.dice_members.imp_rigidbody
...
DiceMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/dice_members/imp_rigidbody.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/dice_members/imp_rigidbody.lua:14-20
...
-- End of hexm.client.entities.local.dice_members.imp_rigidbody