-- ======================================================================
-- Module: hexm.client.entities.local.simple_interactcom_members.imp_hexplugin
...
ImpHexPlugin: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/simple_interactcom_members/imp_hexplugin.lua"
...
-- End of hexm.client.entities.local.simple_interactcom_members.imp_hexplugin