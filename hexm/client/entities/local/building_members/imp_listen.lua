-- ======================================================================
-- Module: hexm.client.entities.local.building_members.imp_listen
...
BuildingMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/building_members/imp_listen.lua"
...
-- End of hexm.client.entities.local.building_members.imp_listen