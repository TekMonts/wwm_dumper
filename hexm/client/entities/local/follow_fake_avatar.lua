-- ======================================================================
-- Module: hexm.client.entities.local.follow_fake_avatar
...
FollowFakeAvatar: class {
  ...
  ENTITY_INIT_COMPONENTS_SIZE: 23
  ...
  __all_declared_listens: table {
    common: table {
      456: table {
        _colorize_on_enter_battle: 19
      }
      457: table {
        _colorize_on_leave_battle: 19
      }
      538: table {
        _on_billboard_interact_after_inited: 24
      }
      593: table {
        _set_effect_visible_by_weapon: 30
      }
      624: table {
        _interact_comp_handler_on_prop_changed: 25
        interact_comp_clear_available_ways_cache: 24
      }
      625: table {
        _interact_comp_handler_on_prop_changed: 25
        interact_comp_clear_available_ways_cache: 24
      ...
      636: table {
        interact_area_on_server_interact_comp_loaded: 23
      }
      637: table {
        interact_area_on_server_interact_comp_unloaded: 23
      }
      638: table {
        interact_area_on_server_interact_refresh: 23
      }
      639: table {
        _interact_comp_handler_on_prop_changed: 25
      }
      642: table {
        _interact_comp_handler_on_prop_changed: 25
        interact_area_on_interact_comp_status_changed: 23
        interact_comp_clear_available_ways_cache: 24
      }
      644: table {
        _interact_comp_handler_on_prop_changed: 25
      ...
      653: table {
        interact_couple_on_related_comp_status_changed: 26
      }
      654: table {
        interact_comp_clear_available_ways_cache: 24
      }
      656: table {
        interact_comp_on_force_change_status: 24
      }
      675: table {
        _colorize_on_start_interacting: 19
      }
      676: table {
        _colorize_on_end_interacting: 19
      }
      693: table {
        _on_active_interact_turn_target: 24
      }
      695: table {
        _colorize_on_interact_comp_handlers_changed: 19
      }
      696: table {
        _interact_comp_handler_on_prop_changed: 25
        interact_comp_clear_available_ways_cache: 24
      ...
      862: table {
        _colorize_on_start_being_trace_target: 19
      }
      863: table {
        _colorize_on_stop_being_trace_target: 19
      }
      1547: table {
        _colorize_on_became_chosen_target: 19
        _on_billboard_refresh_mode_choose_target: 16
      }
      1548: table {
        _colorize_on_stop_became_chosen_target: 19
        _on_billboard_refresh_mode_choose_target: 16
      }
      2129: table {
        _interact_comp_handler_on_prop_changed: 25
      ...
      2013-1011: table {
        _on_guise_hair_changed: 28
      }
      2013-3011: table {
        _on_guise_cloth_changed: 28
      }
      2013-3031: table {
        _on_guise_cloak_changed: 28
      }
      2013-8010: table {
        _on_guise_cloth_top_changed: 28
      }
      2013-9010: table {
        _on_guise_cloth_bottom_changed: 28
      }
    }
    cue: table {
      46: table {
        on_path_finding_event: 21
      }
      353: table {
        on_jump_state_change: 21
      }
      1798: table {
        _on_cue_trigger_trans_change: 24
      }
      2082: table {
        on_cue_start_vat_dissolve: 18
      }
    }
    data: table {
      AvatarCombat-in_battle: table {
        _on_billboard_refresh_mode: 16
      }
      EntityInteractRelationRecord: table {
        interact_relation_on_build_or_destroy: 26
      }
      NpcCombat-in_battle: table {
        _on_billboard_refresh_mode: 16
      }
      billboard_item: table {
        _handle_billboard_item_change: 16
      }
    }
  }
  __component_func_dict__: table {
    ...
    change_model: list [<nested>, <nested>, <nested>, <nested>]
    change_model_over: list [<nested>]
    change_skeleton_ready: list [<nested>, <nested>, <nested>]
    detach: list [<nested>]
    ...
    init: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, ... +3 more]
    leave_space: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
    load_model_over: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
    on_fast_recycle: list [<nested>, <nested>]
    on_fast_reuse: list [<nested>, <nested>, <nested>, <nested>]
    on_reconnected: list [<nested>]
    on_recycled: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
    ...
    pre_fini: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
    pre_reuse: list [<nested>]
    rebind_server: list [<nested>]
    set_view_visible: list [<nested>, <nested>, <nested>, <nested>, <nested>]
    set_visible: list [<nested>, <nested>, <nested>]
    skeleton_ready: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
    space_load_end: list [<nested>]
    view_enter: list [<nested>, <nested>]
    view_fini: list [<nested>]
    view_init: list [<nested>, <nested>, <nested>, <nested>, <nested>, <nested>]
    view_leave: list [<nested>, <nested>, <nested>, <nested>]
    view_load_model_over: list [<nested>]
    view_post: list [<nested>]
    view_skeleton_ready: list [<nested>]
  }
  __component_normal_dict__: table {
    <class AnimBase at 0000023888579CE0>: true
    ...
    <class FaceBase at 000002388A895620>: true
    <class FakeAvatarMember at 0000023899236680>: true
    <class FollowFakeMember at 0000023899233860>: true
    <class FollowFakeMember at 0000023899233AF0>: true
    <class FollowFakeMember at 0000023899236160>: true
    <class FollowFakeMember at 00000238992363F0>: true
    <class FollowFakeMember at 0000023899236BA0>: true
    <class FollowFakeMember at 0000023899236E30>: true
    <class FollowFakeMember at 0000023899237D90>: true
    <class GuiseDyeingBase at 000002388A88F230>: true
    ...
    <class InteractComponentBase at 000002388B3A86C0>: true
    <class InteractRelationBase at 000002388B3A9620>: true
    <class NpcMember at 0000023895A86FE0>: true
  ...
  _change_avatar_face_by_pid_cb_f: function(arg1, arg2, arg3, arg4)  -- @hexm/client/entities/local/follow_fake_members/imp_guise.lua:33-51
  ...
  _get_default_model_lod_level: function(arg1)  -- @hexm/client/entities/local/follow_fake_members/imp_view.lua:13-18
  ...
  _init_graph_anim: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:303-308
  _init_graph_variable: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:283-292
  ...
  _init_shadow_proxy_lod: function(arg1)  -- @hexm/client/entities/local/follow_fake_avatar.lua:35-37
  ...
  billboard_get_nickname: function(arg1)  -- @hexm/client/entities/local/follow_fake_members/imp_billboard.lua:22-24
  ...
  billboard_refresh_nickname: function(arg1)  -- @hexm/client/entities/local/follow_fake_members/imp_billboard.lua:26-40
  ...
  change_avatar_face_by_pid: function(arg1, arg2, arg3, arg4)  -- @hexm/client/entities/local/follow_fake_members/imp_guise.lua:25-31
  change_avatar_guise_and_face_by_pid: function(arg1, arg2, arg3, arg4, arg5)  -- @hexm/client/entities/local/follow_fake_members/imp_guise.lua:54-57
  change_avatar_guise_by_player_id: function(arg1, arg2, arg3, arg4, arg5)  -- @hexm/client/entities/local/follow_fake_members/imp_guise.lua:59-69
  ...
  colorize_can_show_interact_target_material: function(arg1)  -- @hexm/client/entities/local/follow_fake_members/imp_colorize.lua:13-24
  ...
  ctor: function(arg1, arg2, arg3, arg4)  -- @hexm/client/entities/local/follow_fake_avatar.lua:19-23
  ...
  debug_sync_face: function(arg1, arg2)  -- @hexm/client/entities/local/follow_fake_members/imp_guise.lua:17-23
  ...
  get_ai_data: function(arg1)  -- @hexm/client/entities/local/follow_fake_avatar.lua:43-44
  ...
  get_avatar_guise_cb: function(arg1, arg2, arg3, arg4, arg5)  -- @hexm/client/entities/local/follow_fake_members/imp_guise.lua:71-89
  get_avatar_hostnum: function(arg1)  -- @hexm/client/entities/local/follow_fake_avatar.lua:50-52
  get_avatar_id: function(arg1)  -- @hexm/client/entities/local/follow_fake_avatar.lua:46-48
  get_base_gid: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:1355-1357
  get_base_graph: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:663-669
  get_behit_add_graph: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:686-688
  get_behit_cameractrl_graph: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:706-708
  get_behit_graph: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:682-684
  ...
  get_body_type: function(arg1)  -- @hexm/client/entities/local/follow_fake_avatar.lua:59-61
  ...
  get_collect_graph_data: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:501-554
  ...
  get_dialog_graph: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:694-696
  ...
  get_facial_graph: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:690-692
  ...
  get_guise_info: function(arg1)  -- @hexm/client/entities/local/follow_fake_members/imp_guise.lua:91-99
  ...
  get_skill_graph: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:678-680
  ...
  get_special_base_graph: function(arg1)  -- @hexm/client/entities/local/common_members/anim_base.lua:702-704
  ...
  interact_area_need_check_avatar_yaw: function(arg1)  -- @hexm/client/entities/local/follow_fake_members/imp_interact_area.lua:26-33
  ...
  is_allow_shadow_limit: function(arg1)  -- @hexm/client/entities/local/follow_fake_avatar.lua:30-33
  is_allow_shadow_swap_to_disk: function(arg1)  -- @hexm/client/entities/local/follow_fake_avatar.lua:25-28
  ...
  is_client_only_entity: function(arg1)  -- @hexm/client/entities/local/follow_fake_avatar.lua:39-41
  ...
  reset_follow_slot: function(arg1, arg2)  -- @hexm/client/entities/local/follow_fake_members/imp_special_training.lua:80-117
  reset_follow_target: function(arg1, arg2)  -- @hexm/client/entities/local/follow_fake_members/imp_special_training.lua:45-78
  ...
  set_nickname: function(arg1, arg2)  -- @hexm/client/entities/local/follow_fake_members/imp_billboard.lua:18-20
  ...
  update_avatar_info: function(arg1, arg2, arg3)  -- @hexm/client/entities/local/follow_fake_avatar.lua:54-57
...
-- End of hexm.client.entities.local.follow_fake_avatar