-- ======================================================================
-- Module: hexm.client.entities.local.destruct_members.imp_view
...
DestructMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/destruct_members/imp_view.lua"
  ctor: function(...)  -- =[C]
  new: function(...)  -- =[C]
...
-- End of hexm.client.entities.local.destruct_members.imp_view