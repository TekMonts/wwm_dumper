-- ======================================================================
-- Module: hexm.client.entities.local.npc_members.imp_guanqia_func
...
NpcMember: class {
  ...
  __module__: "hexm/client/entities/local/npc_members/imp_guanqia_func.lua"
  sync_guanqia_npc_trace_event: function(arg1, arg2)  -- @hexm/client/entities/local/npc_members/imp_guanqia_func.lua:19-67
}


-- End of hexm.client.entities.local.npc_members.imp_guanqia_func