...
NPC_FILTER_STOP_REASON: "spring_festival_special_training_npc"
...
NpcMember: class {
  ...
  __module__: "hexm/client/entities/local/npc_members/imp_spring_festival_parade_leader.lua"
...
get_spring_festival_fake_avatar_creation_task_id: function(arg1)  -- @hexm/client/entities/local/npc_members/imp_spring_festival_parade_leader.lua:20-22


-- End of hexm.client.entities.local.npc_members.imp_spring_festival_parade_leader