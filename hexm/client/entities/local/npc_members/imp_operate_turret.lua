-- ======================================================================
-- Module: hexm.client.entities.local.npc_members.imp_operate_turret
...
NpcMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/npc_members/imp_operate_turret.lua"
...
-- End of hexm.client.entities.local.npc_members.imp_operate_turret