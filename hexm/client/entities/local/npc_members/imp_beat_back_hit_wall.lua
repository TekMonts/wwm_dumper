-- ======================================================================
-- Module: hexm.client.entities.local.npc_members.imp_beat_back_hit_wall
...
NpcMember: class {
  ...
  __module__: "hexm/client/entities/local/npc_members/imp_beat_back_hit_wall.lua"
...
-- End of hexm.client.entities.local.npc_members.imp_beat_back_hit_wall