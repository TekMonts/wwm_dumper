...
NpcMember: class {
  ...
  __module__: "hexm/client/entities/local/npc_members/imp_special_training_leader.lua"
...
get_fake_avatar_creation_task_id: function(arg1)  -- @hexm/client/entities/local/npc_members/imp_special_training_leader.lua:18-20

get_npc_max: function()  -- @hexm/client/entities/local/npc_members/imp_special_training_leader.lua:22-28


-- End of hexm.client.entities.local.npc_members.imp_special_training_leader