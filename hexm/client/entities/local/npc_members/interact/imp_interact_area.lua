-- ======================================================================
-- Module: hexm.client.entities.local.npc_members.interact.imp_interact_area
...
NpcMember: class {
  ...
  __module__: "hexm/client/entities/local/npc_members/interact/imp_interact_area.lua"
...
-- End of hexm.client.entities.local.npc_members.interact.imp_interact_area