-- ======================================================================
-- Module: hexm.client.entities.local.npc_members.imp_sync_local
...
NpcMember: class {
  ...
  __module__: "hexm/client/entities/local/npc_members/imp_sync_local.lua"
  ctor: function(...)  -- =[C]
  new: function(...)  -- =[C]
...
-- End of hexm.client.entities.local.npc_members.imp_sync_local