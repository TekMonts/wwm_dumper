...
NpcMember: class {
  ...
  __module__: "hexm/client/entities/local/npc_members/imp_sight_manager_local.lua"
  ...
  _sight_on_player_buff_change: function(arg1, arg2, arg3)  -- @hexm/client/entities/local/npc_members/imp_sight_manager_local.lua:377-415
