-- ======================================================================
-- Module: hexm.client.entities.local.npc_members.imp_colorize
...
NpcMember: class {
  ...
  __module__: "hexm/client/entities/local/npc_members/imp_colorize.lua"
...
-- End of hexm.client.entities.local.npc_members.imp_colorize