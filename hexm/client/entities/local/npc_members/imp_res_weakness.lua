...
NpcMember: class {
  ...
  __module__: "hexm/client/entities/local/npc_members/imp_res_weakness.lua"
  ...
  active_npc_res_in_range_changed: function(arg1, arg2)  -- @hexm/client/entities/local/npc_members/imp_res_weakness.lua:217-221
  check_can_break_weakness: function(arg1)  -- @hexm/client/entities/local/npc_members/imp_res_weakness.lua:124-133
  ctor: function(...)  -- =[C]
  get_res_weakness_detail: function(arg1)  -- @hexm/client/entities/local/npc_members/imp_res_weakness.lua:141-143
  new: function(...)  -- =[C]
  notice_main_player_update_res_weakness: function(arg1)  -- @hexm/client/entities/local/npc_members/imp_res_weakness.lua:135-139
  try_clear_res_weakness_state: function(arg1)  -- @hexm/client/entities/local/npc_members/imp_res_weakness.lua:43-54
  try_show_npc_res_weakness_scene_tip: function(arg1, arg2, arg3, arg4)  -- @hexm/client/entities/local/npc_members/imp_res_weakness.lua:161-215
  update_res_weakness_state: function(arg1, arg2, arg3)  -- @hexm/client/entities/local/npc_members/imp_res_weakness.lua:102-122
}
