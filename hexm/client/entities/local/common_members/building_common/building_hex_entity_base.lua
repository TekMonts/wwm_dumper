-- ======================================================================
-- Module: hexm.client.entities.local.common_members.building_common.building_hex_entity_base
...
BuildingHexEntityBase: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/building_common/building_hex_entity_base.lua:13-16
  __module__: "hexm/client/entities/local/common_members/building_common/building_hex_entity..."
...
-- End of hexm.client.entities.local.common_members.building_common.building_hex_entity_base