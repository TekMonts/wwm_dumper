-- ======================================================================
-- Module: hexm.client.entities.local.common_members.building_common.building_wanfa_resource_base
...
BUILDING_DESTRUCT_NPCNO: 1501012

BuildingWanfaResourceBase: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/building_wanfa_resource_base.lua:41-46
  __init_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/building_wanfa_resource_base.lua:17-27
  __module__: "hexm/client/entities/local/common_members/building_common/building_wanfa_reso..."
  __post_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/building_wanfa_resource_base.lua:29-39
...
-- End of hexm.client.entities.local.common_members.building_common.building_wanfa_resource_base