-- ======================================================================
-- Module: hexm.client.entities.local.common_members.building_common.building_connection_base
...
BuildingConnectionBase: class {
  -- Metatable:
  --   __tostring: yes
  __declared_listens: table {
    common: table {
      730: table {
        connection_refresh_all: 0
      }
    }
  }
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/building_connection_base.lua:40-47
  __load_model_over_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/building_connection_base.lua:32-34
  __module__: "hexm/client/entities/local/common_members/building_common/building_connection..."
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/building_common/building_connection_base.lua:21-26
  __rb_load_over_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/building_connection_base.lua:36-38
  __set_chunk_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/building_connection_base.lua:28-30
...
-- End of hexm.client.entities.local.common_members.building_common.building_connection_base