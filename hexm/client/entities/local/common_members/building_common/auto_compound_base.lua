-- ======================================================================
-- Module: hexm.client.entities.local.common_members.building_common.auto_compound_base
...
AutoCompoundBase: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/auto_compound_base.lua:21-24
  __module__: "hexm/client/entities/local/common_members/building_common/auto_compound_base.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/building_common/auto_compound_base.lua:15-19
  __set_chunk_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/auto_compound_base.lua:26-34
...
-- End of hexm.client.entities.local.common_members.building_common.auto_compound_base