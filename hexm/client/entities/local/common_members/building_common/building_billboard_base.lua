-- ======================================================================
-- Module: hexm.client.entities.local.common_members.building_common.building_billboard_base
...
BuildingBillboardBase: class {
  -- Metatable:
  --   __tostring: yes
  __all_resource_load_over_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/building_billboard_base.lua:24-29
  __module__: "hexm/client/entities/local/common_members/building_common/building_billboard_..."
  __post_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/building_billboard_base.lua:17-22
...
-- End of hexm.client.entities.local.common_members.building_common.building_billboard_base