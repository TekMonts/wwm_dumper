-- ======================================================================
-- Module: hexm.client.entities.local.common_members.building_common.attach_cocos
...
ATTACH_WINDOW_REASON: "SELECT"

AttachCocos: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/attach_cocos.lua:21-24
  __module__: "hexm/client/entities/local/common_members/building_common/attach_cocos.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/building_common/attach_cocos.lua:15-19
  __skeleton_ready_component__: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/attach_cocos.lua:26-33
  ...
  get_rotate_render_node_params: function(arg1)  -- @hexm/client/entities/local/common_members/building_common/attach_cocos.lua:124-135
  on_build_edit_selected: function(arg1, arg2, arg3)  -- @hexm/client/entities/local/common_members/building_common/attach_cocos.lua:90-107
...
-- End of hexm.client.entities.local.common_members.building_common.attach_cocos