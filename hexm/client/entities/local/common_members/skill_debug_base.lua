-- ======================================================================
-- Module: hexm.client.entities.local.common_members.skill_debug_base
...
SkillDebugBase: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/common_members/skill_debug_base.lua"
...
-- End of hexm.client.entities.local.common_members.skill_debug_base