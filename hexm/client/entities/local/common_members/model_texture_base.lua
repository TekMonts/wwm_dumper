-- ======================================================================
-- Module: hexm.client.entities.local.common_members.model_texture_base
...
ModelTextureBase: class {
  ...
  __module__: "hexm/client/entities/local/common_members/model_texture_base.lua"
...
-- End of hexm.client.entities.local.common_members.model_texture_base