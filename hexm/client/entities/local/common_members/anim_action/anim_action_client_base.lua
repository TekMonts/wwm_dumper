-- ======================================================================
-- Module: hexm.client.entities.local.common_members.anim_action.anim_action_client_base
...
AnimActionClientBase: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/anim_action/anim_action_client_base.lua:26-35
  __init_component__: function(arg1)  -- @hexm/client/entities/local/common_members/anim_action/anim_action_client_base.lua:18-24
  __module__: "hexm/client/entities/local/common_members/anim_action/anim_action_client_base..."
...
-- End of hexm.client.entities.local.common_members.anim_action.anim_action_client_base