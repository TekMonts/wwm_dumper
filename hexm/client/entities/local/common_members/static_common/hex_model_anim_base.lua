-- ======================================================================
-- Module: hexm.client.entities.local.common_members.static_common.hex_model_anim_base
...
HexModelAnimBase: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/common_members/static_common/hex_model_anim_base.lua"
...
-- End of hexm.client.entities.local.common_members.static_common.hex_model_anim_base