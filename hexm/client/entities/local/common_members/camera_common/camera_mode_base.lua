-- ======================================================================
-- Module: hexm.client.entities.local.common_members.camera_common.camera_mode_base
...
CameraModeBase: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/camera_common/camera_mode_base.lua:21-28
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/camera_common/camera_mode_base.lua:14-19
  __module__: "hexm/client/entities/local/common_members/camera_common/camera_mode_base.lua"
...
-- End of hexm.client.entities.local.common_members.camera_common.camera_mode_base