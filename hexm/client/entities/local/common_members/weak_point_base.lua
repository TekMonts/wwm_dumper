-- ======================================================================
-- Module: hexm.client.entities.local.common_members.weak_point_base
...
WeakPointsBase: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/weak_point_base.lua:32-40
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/weak_point_base.lua:19-25
  __module__: "hexm/client/entities/local/common_members/weak_point_base.lua"
  __skeleton_ready_component__: function(arg1)  -- @hexm/client/entities/local/common_members/weak_point_base.lua:42-45
...
-- End of hexm.client.entities.local.common_members.weak_point_base