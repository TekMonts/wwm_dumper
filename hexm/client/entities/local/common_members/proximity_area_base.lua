-- ======================================================================
-- Module: hexm.client.entities.local.common_members.proximity_area_base
...
ProximityAreaBase: class {
  -- Metatable:
  --   __tostring: yes
  __enter_space_component__: function(arg1)  -- @hexm/client/entities/local/common_members/proximity_area_base.lua:93-102
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/proximity_area_base.lua:64-66
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/proximity_area_base.lua:27-55
  __leave_space_component__: function(arg1)  -- @hexm/client/entities/local/common_members/proximity_area_base.lua:68-81
  __module__: "hexm/client/entities/local/common_members/proximity_area_base.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/proximity_area_base.lua:57-62
...
-- End of hexm.client.entities.local.common_members.proximity_area_base