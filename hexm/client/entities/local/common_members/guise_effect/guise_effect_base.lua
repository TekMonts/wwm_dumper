...
GuiseEffectBase: class {
  ...
  GuiseEffectHandlerClass: instance {
    ...
    default: class {
      -- Metatable:
      --   __tostring: yes
      __module__: "hexm/client/entities/local/common_members/guise_effect/guise_effect_handler_b..."
  ...
  __module__: "hexm/client/entities/local/common_members/guise_effect/guise_effect_base.lua"
