...
LodBase: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/common_members/lod_base.lua"
  ctor: function(...)  -- =[C]
...
debug_get_logic_lod_data: function(arg1)  -- @hexm/client/entities/local/common_members/lod_base.lua:100-131


-- End of hexm.client.entities.local.common_members.lod_base