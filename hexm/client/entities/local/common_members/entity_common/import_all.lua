...
debug_members: instance {
  ...
  1: class {
    ...
    __module__: "hexm/client/entities/local/common_members/entity_common/debug_base.lua"
  ...
  2: class {
    ...
    __module__: "hexm/client/entities/local/common_members/entity_common/debug_show_entity_sta..."
...
members: instance {
  ...
  1: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/client/entities/local/common_members/entity_common/timer_manager_base.lua"
  ...
  2: class {
    ...
    __module__: "hexm/client/entities/local/common_members/entity_common/entity_fast_reuse_bas..."
  ...
  3: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/client/entities/local/common_members/entity_common/entity_reuse_base.lua"
  ...
  4: class {
    ...
    __module__: "hexm/client/entities/local/common_members/entity_common/visibility_base.lua"
  ...
  5: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/client/entities/local/common_members/entity_common/excel_data_base.lua"
  ...
  6: class {
    -- Metatable:
    --   __tostring: yes
    __init_component__: function(arg1)  -- @hexm/client/entities/local/common_members/dispatcher_base.lua:18-23
    __module__: "hexm/client/entities/local/common_members/dispatcher_base.lua"
    __view_init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/dispatcher_base.lua:12-14
  ...
  7: class {
    ...
    __module__: "hexm/client/entities/local/common_members/entity_common/engine_entity_base.lua"
  ...
  8: class {
    -- Metatable:
    --   __tostring: yes
    __module__: "hexm/client/entities/local/common_members/entity_common/transform_changed_bas..."
  ...
  9: class {
    ...
    __module__: "hexm/client/entities/local/common_members/entity_common/shadow_base.lua"
  ...
  10: class {
    ...
    __module__: "hexm/client/entities/local/common_members/entity_common/report_log_base.lua"
