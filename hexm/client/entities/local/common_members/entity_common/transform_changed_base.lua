-- ======================================================================
-- Module: hexm.client.entities.local.common_members.entity_common.transform_changed_base
...
-- End of hexm.client.entities.local.common_members.entity_common.transform_changed_base