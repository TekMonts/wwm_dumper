-- ======================================================================
-- Module: hexm.client.entities.local.common_members.rope_base
...
RopeBase: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/rope_base.lua:23-27
  __module__: "hexm/client/entities/local/common_members/rope_base.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/rope_base.lua:13-21
  ctor: function(...)  -- =[C]
  init_is_rope: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/rope_base.lua:29-31
  is_rope: function(arg1)  -- @hexm/client/entities/local/common_members/rope_base.lua:33-35
  new: function(...)  -- =[C]
  ...
  rope_get_param_id: function(arg1)  -- @hexm/client/entities/local/common_members/rope_base.lua:37-39
...
-- End of hexm.client.entities.local.common_members.rope_base