-- ======================================================================
-- Module: hexm.client.entities.local.common_members.vatmodel_base
...
VATModelBase: class {
  ...
  __module__: "hexm/client/entities/local/common_members/vatmodel_base.lua"
...
-- End of hexm.client.entities.local.common_members.vatmodel_base