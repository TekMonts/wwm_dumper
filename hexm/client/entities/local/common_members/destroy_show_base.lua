-- ======================================================================
-- Module: hexm.client.entities.local.common_members.destroy_show_base
...
DestroyShowBase: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/destroy_show_base.lua:20-27
  __module__: "hexm/client/entities/local/common_members/destroy_show_base.lua"
  __on_fast_reuse_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/destroy_show_base.lua:29-31
  ...
  get_destroy_show_type: function(arg1)  -- @hexm/client/entities/local/common_members/destroy_show_base.lua:50-52
...
-- End of hexm.client.entities.local.common_members.destroy_show_base