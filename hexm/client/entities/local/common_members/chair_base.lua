-- ======================================================================
-- Module: hexm.client.entities.local.common_members.chair_base
...
ChairBase: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/chair_base.lua:15-19
  __module__: "hexm/client/entities/local/common_members/chair_base.lua"
...
-- End of hexm.client.entities.local.common_members.chair_base