-- ======================================================================
-- Module: hexm.client.entities.local.common_members.anim_suffix_base
...
AnimSuffixBase: class {
  -- Metatable:
  --   __tostring: yes
  __across_scene: true
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/anim_suffix_base.lua:25-28
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/anim_suffix_base.lua:12-15
  __module__: "hexm/client/entities/local/common_members/anim_suffix_base.lua"
  __on_recycled_component__: function(arg1)  -- @hexm/client/entities/local/common_members/anim_suffix_base.lua:17-20
...
-- End of hexm.client.entities.local.common_members.anim_suffix_base