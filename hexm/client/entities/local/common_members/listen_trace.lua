-- ======================================================================
-- Module: hexm.client.entities.local.common_members.listen_trace
...
ListenTrace: class {
  ...
  __module__: "hexm/client/entities/local/common_members/listen_trace.lua"
...
-- End of hexm.client.entities.local.common_members.listen_trace