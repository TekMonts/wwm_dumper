-- ======================================================================
-- Module: hexm.client.entities.local.common_members.task_trace_target_base
...
TaskTraceTargetBase: class {
  ...
  __module__: "hexm/client/entities/local/common_members/task_trace_target_base.lua"
...
-- End of hexm.client.entities.local.common_members.task_trace_target_base