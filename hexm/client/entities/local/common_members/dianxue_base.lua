-- ======================================================================
-- Module: hexm.client.entities.local.common_members.dianxue_base
...
AvatarDianxueBase: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/common_members/dianxue_base.lua"
...
DianxueBase: class {
  -- Metatable:
  --   __tostring: yes
  __enter_space_component__: function(arg1)  -- @hexm/client/entities/local/common_members/dianxue_base.lua:24-26
  __init_component__: function(arg1)  -- @hexm/client/entities/local/common_members/dianxue_base.lua:17-22
  __leave_space_component__: function(arg1)  -- @hexm/client/entities/local/common_members/dianxue_base.lua:28-30
  __module__: "hexm/client/entities/local/common_members/dianxue_base.lua"
  cancel_dianxue_ganzhi_dis_detect: function(arg1)  -- @hexm/client/entities/local/common_members/dianxue_base.lua:134-142
  check_can_be_dianxue: function(arg1)  -- @hexm/client/entities/local/common_members/dianxue_base.lua:78-92
  ...
  get_xuewei_config_id: function(arg1)  -- @hexm/client/entities/local/common_members/dianxue_base.lua:32-42
  get_xuewei_list: function(arg1)  -- @hexm/client/entities/local/common_members/dianxue_base.lua:66-76
  new: function(...)  -- =[C]
  recover_xuewei_config_id: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/dianxue_base.lua:52-64
  set_xuewei_config_id: function(arg1, arg2, arg3)  -- @hexm/client/entities/local/common_members/dianxue_base.lua:44-50
}


-- End of hexm.client.entities.local.common_members.dianxue_base