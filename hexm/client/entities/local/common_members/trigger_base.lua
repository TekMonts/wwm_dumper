-- ======================================================================
-- Module: hexm.client.entities.local.common_members.trigger_base
...
TriggerBase: class {
  ...
  __module__: "hexm/client/entities/local/common_members/trigger_base.lua"
...
-- End of hexm.client.entities.local.common_members.trigger_base