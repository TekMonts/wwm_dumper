-- ======================================================================
-- Module: hexm.client.entities.local.common_members.ai_base_local
...
AIBaseLocal: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/ai_base_local.lua:12-15
  __leave_space_component__: function(arg1)  -- @hexm/client/entities/local/common_members/ai_base_local.lua:17-22
  __module__: "hexm/client/entities/local/common_members/ai_base_local.lua"
...
-- End of hexm.client.entities.local.common_members.ai_base_local