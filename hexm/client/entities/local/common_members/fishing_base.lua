...
FishingBase: class {
  ...
  __module__: "hexm/client/entities/local/common_members/fishing_base.lua"
  ...
  check_need_sync_fish_perform: function(arg1)  -- @hexm/client/entities/local/common_members/fishing_base.lua:108-115
