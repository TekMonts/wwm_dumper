-- ======================================================================
-- Module: hexm.client.entities.local.common_members.attach_cocos_base
...
AttachCocosBase: class {
  -- Metatable:
  --   __tostring: yes
  __declared_listens: table {
    common: table {
      284: table {
        _detach_coocs_on_window_close: 0
      }
    }
  }
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/common_members/attach_cocos_base.lua:32-36
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/attach_cocos_base.lua:18-22
  __module__: "hexm/client/entities/local/common_members/attach_cocos_base.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/attach_cocos_base.lua:24-26
...
MAX_SHOW_DISTANCE: 12


-- End of hexm.client.entities.local.common_members.attach_cocos_base