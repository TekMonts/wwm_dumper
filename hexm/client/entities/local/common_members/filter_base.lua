...
FilterBase: class {
  ...
  __leave_space_component__: function(arg1)  -- @hexm/client/entities/local/common_members/filter_base.lua:74-76
  __module__: "hexm/client/entities/local/common_members/filter_base.lua"
