-- ======================================================================
-- Module: hexm.client.entities.local.common_members.collision_sound_effects_base
...
CollisionSoundEffectsBase: class {
  -- Metatable:
  --   __tostring: yes
  ...
  __module__: "hexm/client/entities/local/common_members/collision_sound_effects_base.lua"
  ...
  _inner_trigger_sound: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/collision_sound_effects_base.lua:306-335
  ...
  _trigger_collision_hit: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/collision_sound_effects_base.lua:337-351
...
-- End of hexm.client.entities.local.common_members.collision_sound_effects_base