-- ======================================================================
-- Module: hexm.client.entities.local.point_members.imp_connect
...
PointMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/point_members/imp_connect.lua:37-74
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/point_members/imp_connect.lua:10-15
  __module__: "hexm/client/entities/local/point_members/imp_connect.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/point_members/imp_connect.lua:33-35
...
-- End of hexm.client.entities.local.point_members.imp_connect