-- ======================================================================
-- Module: hexm.client.entities.local.player_avatar_members.gymnastics.imp_gym
...
PlayerAvatarMember: class {
  ...
  __module__: "hexm/client/entities/local/player_avatar_members/gymnastics/imp_gym.lua"
...
-- End of hexm.client.entities.local.player_avatar_members.gymnastics.imp_gym