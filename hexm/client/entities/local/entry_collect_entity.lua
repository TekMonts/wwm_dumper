...
EntryCollectEntity: class {
  ...
  __component_normal_dict__: table {
    ...
    <class EntryCollectMember at 0000019231FEB750>: true
  ...
  __module__: "hexm/client/entities/local/entry_collect_entity.lua"
  ...
  check_can_collision: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:63
  ...
  ctor: function(arg1, arg2, arg3, arg4)  -- @hexm/client/entities/local/entry_collect_entity.lua:17-20
  ...
  get_ai_data: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:50
  get_attach_target_entity: function(arg1)  -- @hexm/client/entities/local/common_members/tach_base.lua:292-297
  get_attr_data: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:52
  get_billboard_data: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:56
  get_combat_data: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:54
  ...
  get_entry_bowu_no: function(arg1)  -- @hexm/client/entities/local/entry_collect_members/imp_entry_collect.lua:149-154
  get_ins_attach_data: function(arg1, arg2)  -- @hexm/client/entities/local/common_members/tach_base.lua:189-216
  get_interact_data: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:55
  get_npc_name: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:48
  ...
  get_ori_model_data: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:51
  ...
  get_value_data: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:57
  has_value_data: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:53
  ...
  init_npc_name: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:22-42
  is_attach_target_ready: function(arg1)  -- @hexm/client/entities/local/common_members/tach_base.lua:251-264
  is_dead: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:65
  is_drop_floor: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:58
  ...
  load_scene_window: function(arg1)  -- @hexm/client/entities/local/entry_collect_members/imp_entry_collect.lua:192-220
  ...
  save_position_info_on_destroy: function(arg1)  -- @hexm/client/entities/local/entry_collect_entity.lua:61
  ...
  set_npc_name: function(arg1, arg2)  -- @hexm/client/entities/local/entry_collect_entity.lua:49
  ...
  try_load_scene_window: function(arg1)  -- @hexm/client/entities/local/entry_collect_members/imp_entry_collect.lua:156-190
...
-- End of hexm.client.entities.local.entry_collect_entity