-- ======================================================================
-- Module: hexm.client.entities.local.camera_members.imp_aim_lock
...
CameraMember: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_aim_lock.lua:16-19
  __module__: "hexm/client/entities/local/camera_members/imp_aim_lock.lua"
...
-- End of hexm.client.entities.local.camera_members.imp_aim_lock