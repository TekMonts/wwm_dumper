-- ======================================================================
-- Module: hexm.client.entities.local.camera_members.imp_trigger_by_state
...
CameraMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/camera_members/imp_trigger_by_state.lua:40-42
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_trigger_by_state.lua:13-19
  __module__: "hexm/client/entities/local/camera_members/imp_trigger_by_state.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_trigger_by_state.lua:21-38
...
-- End of hexm.client.entities.local.camera_members.imp_trigger_by_state