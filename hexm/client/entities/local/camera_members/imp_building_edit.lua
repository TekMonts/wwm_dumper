-- ======================================================================
-- Module: hexm.client.entities.local.camera_members.imp_building_edit
...
CameraMember: class {
  ...
  KEY_MOVE_SPEED: 10
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/camera_members/imp_building_edit.lua:28-31
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_building_edit.lua:18-21
  __module__: "hexm/client/entities/local/camera_members/imp_building_edit.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_building_edit.lua:23-26
...
-- End of hexm.client.entities.local.camera_members.imp_building_edit