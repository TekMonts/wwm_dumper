-- ======================================================================
-- Module: hexm.client.entities.local.camera_members.imp_cue_manager
...
CameraMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/camera_members/imp_cue_manager.lua:17-19
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_cue_manager.lua:11-15
  __module__: "hexm/client/entities/local/camera_members/imp_cue_manager.lua"
...
-- End of hexm.client.entities.local.camera_members.imp_cue_manager