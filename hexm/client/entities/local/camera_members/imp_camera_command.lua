-- ======================================================================
-- Module: hexm.client.entities.local.camera_members.imp_camera_command
...
CameraMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/camera_members/imp_camera_command.lua:28-55
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_camera_command.lua:14-20
  __module__: "hexm/client/entities/local/camera_members/imp_camera_command.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_camera_command.lua:22-26
...
-- End of hexm.client.entities.local.camera_members.imp_camera_command