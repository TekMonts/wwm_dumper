-- ======================================================================
-- Module: hexm.client.entities.local.camera_members.imp_camera_controller
...
CameraMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/camera_members/imp_camera_controller.lua:35-40
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_camera_controller.lua:12-17
  __module__: "hexm/client/entities/local/camera_members/imp_camera_controller.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_camera_controller.lua:19-25
...
-- End of hexm.client.entities.local.camera_members.imp_camera_controller