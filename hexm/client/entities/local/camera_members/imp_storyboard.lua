-- ======================================================================
-- Module: hexm.client.entities.local.camera_members.imp_storyboard
...
CameraMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/camera_members/imp_storyboard.lua:24-26
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_storyboard.lua:11-15
  __module__: "hexm/client/entities/local/camera_members/imp_storyboard.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/camera_members/imp_storyboard.lua:17-22
...
-- End of hexm.client.entities.local.camera_members.imp_storyboard