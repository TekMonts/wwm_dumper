-- ======================================================================
-- Module: hexm.client.entities.local.tree_members.imp_rigidbody
...
TreeMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/tree_members/imp_rigidbody.lua:30-32
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/tree_members/imp_rigidbody.lua:20-28
  __load_model_over_component__: function(arg1)  -- @hexm/client/entities/local/tree_members/imp_rigidbody.lua:34-36
  __module__: "hexm/client/entities/local/tree_members/imp_rigidbody.lua"
...
-- End of hexm.client.entities.local.tree_members.imp_rigidbody