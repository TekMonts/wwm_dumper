-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_ailab_space
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/space_members/imp_ailab_space.lua"
...
-- End of hexm.client.entities.local.space_members.imp_ailab_space