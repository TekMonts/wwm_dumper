...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_group_ai.lua:25-31
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_group_ai.lua:18-23
  __module__: "hexm/client/entities/local/space_members/imp_group_ai.lua"
...
-- End of hexm.client.entities.local.space_members.imp_group_ai