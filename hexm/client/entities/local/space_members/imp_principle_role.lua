-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_principle_role
...
SpaceMember: class {
  ...
  --   __tostring: yes
  __across_scene: true
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_principle_role.lua:21-27
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_principle_role.lua:15-19
  __module__: "hexm/client/entities/local/space_members/imp_principle_role.lua"
...
-- End of hexm.client.entities.local.space_members.imp_principle_role