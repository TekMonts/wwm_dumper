-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_therapy
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_therapy.lua:24-28
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_therapy.lua:14-18
  __module__: "hexm/client/entities/local/space_members/imp_therapy.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_therapy.lua:20-22
...
-- End of hexm.client.entities.local.space_members.imp_therapy