-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_building_cont_group
...
BuildingContGroup: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_building_cont_group.lua:32-37
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_building_cont_group.lua:14-30
  __module__: "hexm/client/entities/local/space_members/imp_building_cont_group.lua"
...
-- End of hexm.client.entities.local.space_members.imp_building_cont_group