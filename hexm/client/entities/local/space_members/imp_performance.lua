-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_performance
...
SPECIAL_STATUS_TAG: "special_performance"

SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_performance.lua:36-51
  __module__: "hexm/client/entities/local/space_members/imp_performance.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_performance.lua:20-34
...
TAG: "SpacePerformance"


-- End of hexm.client.entities.local.space_members.imp_performance