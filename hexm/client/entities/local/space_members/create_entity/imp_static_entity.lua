-- ======================================================================
-- Module: hexm.client.entities.local.space_members.create_entity.imp_static_entity
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/space_members/create_entity/imp_static_entity.lua"
...
-- End of hexm.client.entities.local.space_members.create_entity.imp_static_entity