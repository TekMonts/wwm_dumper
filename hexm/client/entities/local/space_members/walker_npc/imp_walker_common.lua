-- ======================================================================
-- Module: hexm.client.entities.local.space_members.walker_npc.imp_walker_common
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/walker_npc/imp_walker_common.lua:108-117
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/walker_npc/imp_walker_common.lua:35-46
  __module__: "hexm/client/entities/local/space_members/walker_npc/imp_walker_common.lua"
  __post_component__: function(arg1)  -- @hexm/client/entities/local/space_members/walker_npc/imp_walker_common.lua:48-62
  __space_load_over_component__: function(arg1)  -- @hexm/client/entities/local/space_members/walker_npc/imp_walker_common.lua:64-86
...
-- End of hexm.client.entities.local.space_members.walker_npc.imp_walker_common