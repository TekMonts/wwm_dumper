...
SpaceMember: class {
  ...
  --   __tostring: yes
  __across_scene: true
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_delay_task.lua:30-33
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_delay_task.lua:19-28
  __module__: "hexm/client/entities/local/space_members/imp_delay_task.lua"
...
-- End of hexm.client.entities.local.space_members.imp_delay_task