...
SpaceMember: class {
  ...
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_postprocess.lua:55-57
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_postprocess.lua:12-14
  __module__: "hexm/client/entities/local/space_members/imp_postprocess.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_postprocess.lua:51-53
...
-- End of hexm.client.entities.local.space_members.imp_postprocess