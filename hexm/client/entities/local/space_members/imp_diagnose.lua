-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_diagnose
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_diagnose.lua:22
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_diagnose.lua:17-20
  __module__: "hexm/client/entities/local/space_members/imp_diagnose.lua"
...
-- End of hexm.client.entities.local.space_members.imp_diagnose