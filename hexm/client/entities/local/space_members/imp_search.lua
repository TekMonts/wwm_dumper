-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_search
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_search.lua:36-38
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_search.lua:15-34
  __module__: "hexm/client/entities/local/space_members/imp_search.lua"
...
-- End of hexm.client.entities.local.space_members.imp_search