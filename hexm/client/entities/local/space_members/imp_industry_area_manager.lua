-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_industry_area_manager
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/space_members/imp_industry_area_manager.lua"
...
-- End of hexm.client.entities.local.space_members.imp_industry_area_manager