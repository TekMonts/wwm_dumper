-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_guide_effect
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_guide_effect.lua:17-19
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_guide_effect.lua:12-15
  __module__: "hexm/client/entities/local/space_members/imp_guide_effect.lua"
...
-- End of hexm.client.entities.local.space_members.imp_guide_effect