-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_space_region
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_space_region.lua:5-7
  __module__: "hexm/client/entities/local/space_members/imp_space_region.lua"
  ctor: function(...)  -- =[C]
...
-- End of hexm.client.entities.local.space_members.imp_space_region