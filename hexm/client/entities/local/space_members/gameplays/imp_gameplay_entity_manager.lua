-- ======================================================================
-- Module: hexm.client.entities.local.space_members.gameplays.imp_gameplay_entity_manager
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/gameplays/imp_gameplay_entity_manager.lua:13-15
  __module__: "hexm/client/entities/local/space_members/gameplays/imp_gameplay_entity_manage..."
...
-- End of hexm.client.entities.local.space_members.gameplays.imp_gameplay_entity_manager