-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_burning_field
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_burning_field.lua:23-25
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_burning_field.lua:12-17
  __module__: "hexm/client/entities/local/space_members/imp_burning_field.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_burning_field.lua:19-21
...
-- End of hexm.client.entities.local.space_members.imp_burning_field