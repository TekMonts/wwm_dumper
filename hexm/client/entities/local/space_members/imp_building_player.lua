-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_building_player
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_building_player.lua:19-22
  __module__: "hexm/client/entities/local/space_members/imp_building_player.lua"
...
-- End of hexm.client.entities.local.space_members.imp_building_player