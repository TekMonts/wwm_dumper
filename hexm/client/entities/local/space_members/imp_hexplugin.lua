...
SpaceMember: class {
  ...
  --   __tostring: yes
  __across_scene: true
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_hexplugin.lua:27-31
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_hexplugin.lua:11-25
  __module__: "hexm/client/entities/local/space_members/imp_hexplugin.lua"
...
-- End of hexm.client.entities.local.space_members.imp_hexplugin