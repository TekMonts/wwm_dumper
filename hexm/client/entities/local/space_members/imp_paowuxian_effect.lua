-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_paowuxian_effect
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_paowuxian_effect.lua:18-23
  __init_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_paowuxian_effect.lua:12-16
  __module__: "hexm/client/entities/local/space_members/imp_paowuxian_effect.lua"
...
-- End of hexm.client.entities.local.space_members.imp_paowuxian_effect