-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_debate
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_debate.lua:10-14
  __module__: "hexm/client/entities/local/space_members/imp_debate.lua"
...
-- End of hexm.client.entities.local.space_members.imp_debate