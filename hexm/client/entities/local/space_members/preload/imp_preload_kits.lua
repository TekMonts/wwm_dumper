-- ======================================================================
-- Module: hexm.client.entities.local.space_members.preload.imp_preload_kits
...
PRELOAD_CELL_MAX_EXEC_TIME: 200000

SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/preload/imp_preload_kits.lua:41-52
  __init_component__: function(arg1)  -- @hexm/client/entities/local/space_members/preload/imp_preload_kits.lua:20-35
  __module__: "hexm/client/entities/local/space_members/preload/imp_preload_kits.lua"
  __post_component__: function(arg1)  -- @hexm/client/entities/local/space_members/preload/imp_preload_kits.lua:37-39
...
-- End of hexm.client.entities.local.space_members.preload.imp_preload_kits