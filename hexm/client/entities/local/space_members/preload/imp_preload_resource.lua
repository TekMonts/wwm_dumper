...
SpaceMember: class {
  ...
  --   __tostring: yes
  __across_scene: true
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/preload/imp_preload_resource.lua:36-40
  __init_component__: function(arg1)  -- @hexm/client/entities/local/space_members/preload/imp_preload_resource.lua:18-23
  __module__: "hexm/client/entities/local/space_members/preload/imp_preload_resource.lua"
  __post_component__: function(arg1)  -- @hexm/client/entities/local/space_members/preload/imp_preload_resource.lua:25-34
