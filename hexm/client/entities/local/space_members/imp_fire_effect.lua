-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_fire_effect
...
CLOSE_FIRE_TAG_WHEN_RAIN: instance {
  -- Metatable:
  --   __index: table
  --   __tostring: yes
  1: "QuenchableFire"
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_fire_effect.lua:27-39
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_fire_effect.lua:21-25
  __module__: "hexm/client/entities/local/space_members/imp_fire_effect.lua"
  __space_load_over_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_fire_effect.lua:41-43
...
-- End of hexm.client.entities.local.space_members.imp_fire_effect