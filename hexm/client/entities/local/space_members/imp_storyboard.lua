-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_storyboard
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_storyboard.lua:22-27
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_storyboard.lua:12-14
  __module__: "hexm/client/entities/local/space_members/imp_storyboard.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_storyboard.lua:16-20
...
-- End of hexm.client.entities.local.space_members.imp_storyboard