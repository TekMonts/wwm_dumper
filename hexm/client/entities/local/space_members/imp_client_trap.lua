-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_client_trap
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_client_trap.lua:9-13
  __module__: "hexm/client/entities/local/space_members/imp_client_trap.lua"
...
-- End of hexm.client.entities.local.space_members.imp_client_trap