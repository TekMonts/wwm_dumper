-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_cell
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_cell.lua:15-18
  __module__: "hexm/client/entities/local/space_members/imp_cell.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_cell.lua:9-13
...
-- End of hexm.client.entities.local.space_members.imp_cell