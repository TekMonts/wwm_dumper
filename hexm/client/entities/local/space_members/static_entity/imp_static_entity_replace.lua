-- ======================================================================
-- Module: hexm.client.entities.local.space_members.static_entity.imp_static_entity_replace
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/static_entity/imp_static_entity_replace.lua:36-47
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/static_entity/imp_static_entity_replace.lua:20-23
  __module__: "hexm/client/entities/local/space_members/static_entity/imp_static_entity_repl..."
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/static_entity/imp_static_entity_replace.lua:25-34
...
-- End of hexm.client.entities.local.space_members.static_entity.imp_static_entity_replace