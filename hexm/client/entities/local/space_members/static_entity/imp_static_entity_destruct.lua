-- ======================================================================
-- Module: hexm.client.entities.local.space_members.static_entity.imp_static_entity_destruct
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/static_entity/imp_static_entity_destruct.lua:14-19
  __module__: "hexm/client/entities/local/space_members/static_entity/imp_static_entity_dest..."
  __space_load_over_component__: function(arg1)  -- @hexm/client/entities/local/space_members/static_entity/imp_static_entity_destruct.lua:21-22
  ctor: function(...)  -- =[C]
...
-- End of hexm.client.entities.local.space_members.static_entity.imp_static_entity_destruct