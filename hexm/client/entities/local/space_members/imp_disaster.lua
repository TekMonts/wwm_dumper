-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_disaster
...
SpaceMember: class {
  ...
  --   __tostring: yes
  __across_scene: true
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_disaster.lua:55-66
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_disaster.lua:17-25
  __module__: "hexm/client/entities/local/space_members/imp_disaster.lua"
  __pre_reuse_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_disaster.lua:43-53
  __space_load_over_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_disaster.lua:27-41
...
-- End of hexm.client.entities.local.space_members.imp_disaster