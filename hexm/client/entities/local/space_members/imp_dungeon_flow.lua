-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_dungeon_flow
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_dungeon_flow.lua:19-21
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_dungeon_flow.lua:10-13
  __module__: "hexm/client/entities/local/space_members/imp_dungeon_flow.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_dungeon_flow.lua:15-17
...
-- End of hexm.client.entities.local.space_members.imp_dungeon_flow