-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_npc_statistics
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_npc_statistics.lua:13-16
  __init_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_npc_statistics.lua:7-11
  __module__: "hexm/client/entities/local/space_members/imp_npc_statistics.lua"
  ctor: function(...)  -- =[C]
...
-- End of hexm.client.entities.local.space_members.imp_npc_statistics