-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_helper_vehicle
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/space_members/imp_helper_vehicle.lua"
  ctor: function(...)  -- =[C]
  new: function(...)  -- =[C]
...
-- End of hexm.client.entities.local.space_members.imp_helper_vehicle