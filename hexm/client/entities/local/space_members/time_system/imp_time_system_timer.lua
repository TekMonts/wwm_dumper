-- ======================================================================
-- Module: hexm.client.entities.local.space_members.time_system.imp_time_system_timer
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/time_system/imp_time_system_timer.lua:10-12
  __init_component__: function(arg1)  -- @hexm/client/entities/local/space_members/time_system/imp_time_system_timer.lua:6-8
  __module__: "hexm/client/entities/local/space_members/time_system/imp_time_system_timer.lua"
...
-- End of hexm.client.entities.local.space_members.time_system.imp_time_system_timer