-- ======================================================================
-- Module: hexm.client.entities.local.space_members.imp_space_record_gm
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_space_record_gm.lua:17-19
  __init_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_space_record_gm.lua:12-15
  __module__: "hexm/client/entities/local/space_members/imp_space_record_gm.lua"
  ctor: function(...)  -- =[C]
...
-- End of hexm.client.entities.local.space_members.imp_space_record_gm