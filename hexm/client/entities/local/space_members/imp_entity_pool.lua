...
SPECIAL_COMB_CLOTH_TYPE: -1

SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/space_members/imp_entity_pool.lua:48-54
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/space_members/imp_entity_pool.lua:30-46
  __module__: "hexm/client/entities/local/space_members/imp_entity_pool.lua"
...
-- End of hexm.client.entities.local.space_members.imp_entity_pool