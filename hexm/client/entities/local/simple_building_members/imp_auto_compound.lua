-- ======================================================================
-- Module: hexm.client.entities.local.simple_building_members.imp_auto_compound
...
ImpAutoCompound: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/simple_building_members/imp_auto_compound.lua"
...
-- End of hexm.client.entities.local.simple_building_members.imp_auto_compound