-- ======================================================================
-- Module: hexm.client.entities.local.room_buildings_members.imp_rigidbody
...
RoomBuildingMember: class {
  -- Metatable:
  --   __tostring: yes
  __change_model_component__: function(arg1)  -- @hexm/client/entities/local/room_buildings_members/imp_rigidbody.lua:39-46
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/room_buildings_members/imp_rigidbody.lua:34-37
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/room_buildings_members/imp_rigidbody.lua:15-18
  __module__: "hexm/client/entities/local/room_buildings_members/imp_rigidbody.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/room_buildings_members/imp_rigidbody.lua:20-32
...
-- End of hexm.client.entities.local.room_buildings_members.imp_rigidbody