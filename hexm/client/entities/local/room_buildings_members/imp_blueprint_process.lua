-- ======================================================================
-- Module: hexm.client.entities.local.room_buildings_members.imp_blueprint_process
...
ImpBlueprintProcess: class {
  -- Metatable:
  --   __tostring: yes
  __all_resource_load_over_component__: function(arg1)  -- @hexm/client/entities/local/room_buildings_members/imp_blueprint_process.lua:34-42
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/room_buildings_members/imp_blueprint_process.lua:26-28
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/room_buildings_members/imp_blueprint_process.lua:14-16
  __module__: "hexm/client/entities/local/room_buildings_members/imp_blueprint_process.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/room_buildings_members/imp_blueprint_process.lua:18-24
...
-- End of hexm.client.entities.local.room_buildings_members.imp_blueprint_process