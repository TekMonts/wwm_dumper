-- ======================================================================
-- Module: hexm.client.entities.local.room_buildings_members.imp_attach_cocos
...
RoomBuildingsMember: class {
  ...
  __module__: "hexm/client/entities/local/room_buildings_members/imp_attach_cocos.lua"
...
-- End of hexm.client.entities.local.room_buildings_members.imp_attach_cocos