-- ======================================================================
-- Module: hexm.client.entities.local.room_buildings_members.imp_base_attr
...
RoomBuildingsMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/room_buildings_members/imp_base_attr.lua"
...
-- End of hexm.client.entities.local.room_buildings_members.imp_base_attr