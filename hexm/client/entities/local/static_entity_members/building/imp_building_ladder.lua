-- ======================================================================
-- Module: hexm.client.entities.local.static_entity_members.building.imp_building_ladder
...
StaticEntityMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/static_entity_members/building/imp_building_ladder.lua:41-47
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/static_entity_members/building/imp_building_ladder.lua:18-24
  __module__: "hexm/client/entities/local/static_entity_members/building/imp_building_ladder..."
  __post_component__: function(arg1, arg2)  -- @hexm/client/entities/local/static_entity_members/building/imp_building_ladder.lua:26-34
  __space_load_end_component__: function(arg1)  -- @hexm/client/entities/local/static_entity_members/building/imp_building_ladder.lua:36-39
...
-- End of hexm.client.entities.local.static_entity_members.building.imp_building_ladder