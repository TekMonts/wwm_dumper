-- ======================================================================
-- Module: hexm.client.entities.local.static_entity_members.imp_view
...
ImpView: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/entities/local/static_entity_members/imp_view.lua:17-22
  __init_component__: function(arg1)  -- @hexm/client/entities/local/static_entity_members/imp_view.lua:13-15
  __module__: "hexm/client/entities/local/static_entity_members/imp_view.lua"
  ctor: function(...)  -- =[C]
  new: function(...)  -- =[C]
...
-- End of hexm.client.entities.local.static_entity_members.imp_view