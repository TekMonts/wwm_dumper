-- ======================================================================
-- Module: hexm.client.entities.local.static_entity_members.imp_trigger_pressure
...
StaticEntityMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/static_entity_members/imp_trigger_pressure.lua"
...
-- End of hexm.client.entities.local.static_entity_members.imp_trigger_pressure