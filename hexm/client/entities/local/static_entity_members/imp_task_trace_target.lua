-- ======================================================================
-- Module: hexm.client.entities.local.static_entity_members.imp_task_trace_target
...
ImpTaskTraceTarget: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/static_entity_members/imp_task_trace_target.lua"
...
-- End of hexm.client.entities.local.static_entity_members.imp_task_trace_target