-- ======================================================================
-- Module: hexm.client.entities.local.static_entity_members.imp_interact_comp
...
StaticEntityMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/entities/local/static_entity_members/imp_interact_comp.lua"
...
-- End of hexm.client.entities.local.static_entity_members.imp_interact_comp