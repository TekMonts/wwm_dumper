-- ======================================================================
-- Module: hexm.client.entities.local.trap_members.imp_zaotang
...
TrapMember: class {
  -- Metatable:
  --   __tostring: yes
  __enter_space_component__: function(arg1)  -- @hexm/client/entities/local/trap_members/imp_zaotang.lua:20-29
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/trap_members/imp_zaotang.lua:6-18
  __leave_space_component__: function(arg1)  -- @hexm/client/entities/local/trap_members/imp_zaotang.lua:31-38
  __module__: "hexm/client/entities/local/trap_members/imp_zaotang.lua"
...
-- End of hexm.client.entities.local.trap_members.imp_zaotang