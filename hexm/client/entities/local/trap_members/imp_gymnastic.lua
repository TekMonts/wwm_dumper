-- ======================================================================
-- Module: hexm.client.entities.local.trap_members.imp_gymnastic
...
TrapMember: class {
  -- Metatable:
  --   __tostring: yes
  __enter_space_component__: function(arg1)  -- @hexm/client/entities/local/trap_members/imp_gymnastic.lua:16-21
  __init_component__: function(arg1, arg2)  -- @hexm/client/entities/local/trap_members/imp_gymnastic.lua:10-14
  __module__: "hexm/client/entities/local/trap_members/imp_gymnastic.lua"
  __on_main_player_enter_component__: function(arg1)  -- @hexm/client/entities/local/trap_members/imp_gymnastic.lua:87-95
  __on_main_player_leave_component__: function(arg1)  -- @hexm/client/entities/local/trap_members/imp_gymnastic.lua:97-105
...
-- End of hexm.client.entities.local.trap_members.imp_gymnastic