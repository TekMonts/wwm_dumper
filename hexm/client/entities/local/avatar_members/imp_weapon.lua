...
AvatarMember: class {
  ...
  __module__: "hexm/client/entities/local/avatar_members/imp_weapon.lua"
  _on_combat_mode_changed: function(arg1)  -- @hexm/client/entities/local/avatar_members/imp_weapon.lua:19-21
  enable_hide_weapon_for_perf: function(arg1, arg2)  -- @hexm/client/entities/local/avatar_members/imp_weapon.lua:23-28
  refresh_hide_weapon_for_perf: function(arg1)  -- @hexm/client/entities/local/avatar_members/imp_weapon.lua:30-37
}
