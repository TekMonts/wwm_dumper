...
AvatarMember: class {
  ...
  __module__: "hexm/client/entities/local/avatar_members/imp_dead.lua"
  ...
  _on_dead_model_load_over: function(arg1)  -- @hexm/client/entities/local/avatar_members/imp_dead.lua:113-119
  _on_dead_state_change: function(arg1, arg2, arg3)  -- @hexm/client/entities/local/avatar_members/imp_dead.lua:40-47
  apply_dead: function(arg1, arg2)  -- @hexm/client/entities/local/avatar_members/imp_dead.lua:49-111
