...
BillboardEntity: class {
  ...
  __component_normal_dict__: table {
    <class BillboardEntityMember at 000001922FFA4150>: true
    <class BillboardEntityMember at 000001922FFA5D80>: true
    <class BillboardEntityMember at 000001922FFA6010>: true
    <class BillboardEntityMember at 000001922FFA90C0>: true
    <class TimerManagerBase at 0000018FD53FCF60>: true
  }
  __components__: list [<nested>, <circular>, <circular>, <circular>, <circular>]
  __module__: "hexm/client/entities/local/billboard_entity.lua"
