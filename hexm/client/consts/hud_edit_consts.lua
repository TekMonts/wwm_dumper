  ...
  editing_root: instance {
    ...
    hud_windows_wrapper: instance {
      ...
      children: instance {
        ...
        button_mobile_biaoji: instance {
          -- Metatable:
          --   __index: table
          --   __tostring: yes
          anchor_view: "drag_biaoji"
          drag_nodes: instance {
            -- Metatable:
            --   __index: table
            --   __tostring: yes
        ...
        chiji_dingwei: instance {
          -- Metatable:
          --   __index: table
          --   __tostring: yes
          anchor_view: "drag_dingwei"
          drag_nodes: instance {
            -- Metatable:
            --   __index: table
            --   __tostring: yes
        ...
        chiji_diren: instance {
          -- Metatable:
          --   __index: table
          --   __tostring: yes
          anchor_view: "drag_diren"
          drag_nodes: instance {
            -- Metatable:
            --   __index: table
            --   __tostring: yes
        ...
        chiji_xianshi: instance {
          -- Metatable:
          --   __index: table
          --   __tostring: yes
          anchor_view: "drag_xianshi"
          drag_nodes: instance {
            -- Metatable:
            --   __index: table
            --   __tostring: yes
        ...
        drag_joystick: instance {
          -- Metatable:
          --   __index: table
          --   __tostring: yes
          anchor_view: "drag_joystick"
          drag_nodes: instance {
            -- Metatable:
            --   __index: table
            --   __tostring: yes
          ...
          node_type: "hud_wrapper"
          show_name: "摇杆"
          visible_func: function()  -- @hexm/client/consts/hud_edit_consts.lua:207
        }
        drag_xunlu: instance {
          -- Metatable:
          --   __index: table
          --   __tostring: yes
          anchor_view: "button_xunlu"
          drag_nodes: instance {
            -- Metatable:
            --   __index: table
            --   __tostring: yes
        ...
        xiajing_shuju: instance {
          -- Metatable:
          --   __index: table
          --   __tostring: yes
          anchor_view: "drag_shuju"
          drag_nodes: instance {
            -- Metatable:
            --   __index: table
            --   __tostring: yes
    ...
    skill_window: instance {
      ...
      children: instance {
        ...
        skill27: instance {
          ...
          --   __index: table
          --   __tostring: yes
          anchor_view: "skill27_pos"
          name: "skill27"
          node_type: "dynamic_skill_slot"
          view_cls: "MobileAutoComboIconImp"
        }
        skill28: instance {
          -- Metatable:
          --   __index: table
...
NODE_BOTTOM_JOY_GROUP: "drag_joystick"

NODE_BOTTOM_LEFT_GROUP: "bottom_left_group"

NODE_BOTTOM_XUNLU_GROUP: "drag_xunlu"

NODE_CENTER_LIST_GROUP: "center_list_group"

NODE_CHIJI_DINGWEI: "chiji_dingwei"

NODE_CHIJI_DIREN: "chiji_diren"

NODE_CHIJI_NEED: "chiji_need"

NODE_CHIJI_XIANSHI: "chiji_xianshi"

NODE_COMBO_WINDOW: "combo_window"

NODE_DUNGEON_JOYSTICK: "button_mobile_biaoji"
...
NODE_XIAJING_SHUJU: "xiajing_shuju"
...
SLOT_IDX_TO_EXPOSURE_NODE_KEY: instance {
  ...
  17: "skill_custom1_pos"
  18: "skill_custom2_pos"
  19: "skill_custom3_pos"
  20: "skill_custom4_pos"
}

WANFA_TEXTS: instance {
  -- Metatable:
  --   __index: table
  --   __tostring: yes
  1: 1010187
...
get_skill_view_cls: function(arg1)  -- @hexm/client/consts/hud_edit_consts.lua:120-123
