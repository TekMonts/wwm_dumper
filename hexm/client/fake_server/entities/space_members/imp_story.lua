-- ======================================================================
-- Module: hexm.client.fake_server.entities.space_members.imp_story
...
SpaceMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/fake_server/entities/space_members/imp_story.lua"
  ctor: function(...)  -- =[C]
...
-- End of hexm.client.fake_server.entities.space_members.imp_story