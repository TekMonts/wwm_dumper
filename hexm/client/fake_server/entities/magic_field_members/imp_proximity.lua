-- ======================================================================
-- Module: hexm.client.fake_server.entities.magic_field_members.imp_proximity
...
FakeMagicFieldMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/fake_server/entities/magic_field_members/imp_proximity.lua"
...
-- End of hexm.client.fake_server.entities.magic_field_members.imp_proximity