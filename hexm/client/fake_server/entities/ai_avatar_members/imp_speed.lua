-- ======================================================================
-- Module: hexm.client.fake_server.entities.ai_avatar_members.imp_speed
...
FakeAIAvatarMember: class {
  -- Metatable:
  --   __tostring: yes
  __fini_component__: function(arg1)  -- @hexm/client/fake_server/entities/ai_avatar_members/imp_speed.lua:30-35
  __init_component__: function(arg1, arg2)  -- @hexm/client/fake_server/entities/ai_avatar_members/imp_speed.lua:10-16
  __module__: "hexm/client/fake_server/entities/ai_avatar_members/imp_speed.lua"
  __post_component__: function(arg1, arg2)  -- @hexm/client/fake_server/entities/ai_avatar_members/imp_speed.lua:18-23
...
-- End of hexm.client.fake_server.entities.ai_avatar_members.imp_speed