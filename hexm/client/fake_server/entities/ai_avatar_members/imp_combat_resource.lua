-- ======================================================================
-- Module: hexm.client.fake_server.entities.ai_avatar_members.imp_combat_resource
...
FakeAIAvatarMember: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/fake_server/entities/ai_avatar_members/imp_combat_resource.lua"
...
-- End of hexm.client.fake_server.entities.ai_avatar_members.imp_combat_resource