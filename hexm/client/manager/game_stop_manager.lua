...
GameStopManager: class {
  -- Metatable:
  --   __tostring: yes
  __module__: "hexm/client/manager/game_stop_manager.lua"
  _enter_game_stop_state: function(arg1)  -- @hexm/client/manager/game_stop_manager.lua:103-138
  _leave_game_stop_state: function(arg1)  -- @hexm/client/manager/game_stop_manager.lua:140-171
  ...
  is_support_game_stop: function(arg1)  -- @hexm/client/manager/game_stop_manager.lua:173-177
