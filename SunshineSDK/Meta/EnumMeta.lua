...
DefEnum: class {
  ...
  __module__: "SunshineSDK/Meta/EnumMeta.lua"
...
EnumMetas: table {
  ...
  ALAirBuffType: <instance>
  ALAnimActionRef: <instance>
  ALAnimEventTarget: <instance>
  ...
  ALBodyType: <instance>
  ALBoneRotateTargetType: <instance>
  ...
  ALCenterDistanceDetectRef: <instance>
  ALCheckBeLockType: <instance>
  ALCheckBuffEffectType: <instance>
  ...
  ALCreateDoveByCameraDirectionRule: <instance>
  ...
  ALRayCastFilterTargetsStartType: <instance>
  ...
  ALSaveTempValueKey: <instance>
  ALSaveTempValueType: <instance>
  ...
  ALSetResourceMaxResumeType: <instance>
  ALSkillSelectTargetsOption: <instance>
  ALSkillStateOption: <instance>
  ALSummonInheritResType: <instance>
  ALSummonListenResType: <instance>
  ...
  MathOperation: <instance>
  VecMathOperation: <instance>
}
