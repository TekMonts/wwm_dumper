...
area: class {
  ...
  clear_update_aoi_info_with_pitch_roll_callback: function(...)  -- =[C]
  ctor: function(...)  -- =[C]
  ...
  get_send_position_with_pitch_roll_callback: function(...)  -- =[C]
  ...
  has_update_aoi_info_with_pitch_roll_callback: function(...)  -- =[C]
  in_aoi: function(...)  -- =[C]
  ...
  send_position_with_pitch_roll_to_server: function(...)  -- =[C]
  ...
  set_update_aoi_info_with_pitch_roll_callback: function(...)  -- =[C]
  set_yaw: function(...)  -- =[C]
